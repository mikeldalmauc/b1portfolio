...
var $author$project$Types$Entregable = F6(
	function (codigo, route, descripcionEntregable, tipoEvidencia, tituloModal, vistaModal) {
		return {codigo: codigo, descripcionEntregable: descripcionEntregable, route: route, tipoEvidencia: tipoEvidencia, tituloModal: tituloModal, vistaModal: vistaModal};
	});
...
var $author$project$Views$ContenidosViews$breadcrumbs = F2(
...
var $author$project$Views$ContenidosViews$videoView = F2(
	function (d, src) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($author$project$Views$ContenidosViews$videoView, d, 'https://www.youtube.com/embed/a4ljkcniF4U?si=GBCfKhfEx-MxMFJ9')
			]));
};
...
var $author$project$Views$ContenidosViews$footerNavigation = F3(
		...
		var prevLink = function () {
			if (prev.$ === 'Just') {
				...
				return A2(
					...
					_List_fromArray(
						[
							A2($author$project$Styles$leftArrowSvg, _List_Nil, $author$project$Styles$grisclaroHex),
							A2(
							$mdgriffith$elm_ui$Element$paragraph,
							textAttrs,
							_List_fromArray(
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							A2($author$project$Styles$rightArrowSvg, _List_Nil, $author$project$Styles$grisclaroHex)
						]));
			} else {
				return $mdgriffith$elm_ui$Element$none;
			}
...
var $author$project$Entregables$Entregable1$view = function (d) {
	return A2(
		...
		_List_fromArray(
			[
				A2(
				$author$project$Views$ContenidosViews$breadcrumbs,
				d,
				_List_fromArray(
					[
						$elm$core$Maybe$Just(
				...
				A3(
				$author$project$Views$ContenidosViews$footerNavigation,
				d,
				$elm$core$Maybe$Just(
					_Utils_Tuple2(
						$author$project$Route$HomepageRoute,
...
var $author$project$Lottie$viewWip = A2(
	...
	A2(
		...
		$mdgriffith$elm_ui$Element$none));
var $author$project$Views$ContenidosViews$wip = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
...
var $author$project$Entregables$Entregable2$content = function (d) {
	return $author$project$Views$ContenidosViews$wip(d);
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($author$project$Views$ContenidosViews$videoView, d, 'https://www.youtube.com/embed/hNg9d6tfjJ0?si=Vi-TOMIWXIiQ008Q')
			]));
};
	...
	function (dimensions, url, key) {
		...
		if (_v0.$ === 'Just') {
			...
			return _Utils_Tuple2(
				_Utils_update(
					baseModel,
					{modalTitle: entregable.tituloModal, modalView: entregable.vistaModal, modalVisibility: $author$project$Types$Visible}),
						...
						$elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									...
									$elm$core$Task$perform,
									function (_v3) {
										return $author$project$Types$OpenModal(entregable);
									},
									$elm$core$Task$succeed(_Utils_Tuple0)),
									scrollCmd,
									$author$project$Main$startLottieAnimations,
...
var $author$project$Views$Botones$backButton = function (model) {
	return A2(
		...
		$author$project$Styles$negroHex);
};
...
var $author$project$Views$PhoneView$view = function (model) {
	var sideFiller = A2(
		...
		$mdgriffith$elm_ui$Element$none);
	var phoneHeaderView = _Utils_eq(model.modalVisibility, $author$project$Types$Visible) ? $author$project$Views$Header$phoneHeaderBack(model) : $author$project$Views$Header$phoneHeader(model);
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							sideFiller,
							_Utils_eq(model.modalVisibility, $author$project$Types$Visible) ? A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$centerX,
							...
							model.modalView(model.dimensions)) : mainBlock,
							sideFiller
						])),
					$author$project$Views$Footer$footer
				])));
