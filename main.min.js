			...
			case 'OpenMenu':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							menuVisible: _Utils_eq(model.menuVisible, $author$project$Types$Visible) ? $author$project$Types$Hidden : $author$project$Types$Visible
						}),
		...
		A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Events$onClick($author$project$Types$OpenMenu),
							$mdgriffith$elm_ui$Element$htmlAttribute(
