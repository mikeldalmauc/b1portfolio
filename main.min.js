	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'DeviceClassified':
				...
				var device = $mdgriffith$elm_ui$Element$classifyDevice(dimensions);
				var message = function () {
					var _v7 = device._class;
					if (_v7.$ === 'Phone') {
						return $elm$core$Platform$Cmd$none;
					} else {
						return _Utils_eq(model.device._class, $mdgriffith$elm_ui$Element$Phone) ? A2(
							$elm$core$Task$perform,
							function (_v8) {
								return $author$project$Types$LottieMsg;
							},
