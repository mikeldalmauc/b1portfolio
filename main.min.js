...
var $author$project$Views$Header$encabezadoFijado = A2(
...
var $author$project$Views$Header$headerHtml = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[$author$project$Views$Header$encabezadoFijado]));
...
var $author$project$Views$DesktopView$view = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Views$Header$headerHtml,
				A2(
				$mdgriffith$elm_ui$Element$layout,
				_Utils_ap(
					menu,
