...
var $author$project$Types$Categories = {$: 'Categories'};
var $author$project$Types$Hidden = {$: 'Hidden'};
var $author$project$Types$Visible = {$: 'Visible'};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $author$project$Types$Highlight = {$: 'Highlight'};
var $author$project$Main$checkMarkdownHighlight = A2(
	$elm$core$Task$perform,
	function (_v0) {
		return $author$project$Types$Highlight;
	},
...
var $author$project$Route$Entregable1 = {$: 'Entregable1'};
var $author$project$Route$Entregable1A = {$: 'Entregable1A'};
var $author$project$Route$Entregable1B = {$: 'Entregable1B'};
var $author$project$Route$Entregable1C = {$: 'Entregable1C'};
var $author$project$Route$Entregable2 = {$: 'Entregable2'};
var $author$project$Route$Entregable2A = {$: 'Entregable2A'};
var $author$project$Route$Entregable2B = {$: 'Entregable2B'};
var $author$project$Route$Entregable3 = {$: 'Entregable3'};
var $author$project$Route$Entregable3A = {$: 'Entregable3A'};
var $author$project$Route$Entregable3B = {$: 'Entregable3B'};
var $author$project$Route$Entregable4 = {$: 'Entregable4'};
var $author$project$Route$Entregable4A = {$: 'Entregable4A'};
var $author$project$Route$Entregable4B = {$: 'Entregable4B'};
var $author$project$Route$Entregable4C = {$: 'Entregable4C'};
var $author$project$Route$Entregable5 = {$: 'Entregable5'};
var $author$project$Route$Entregable5A = {$: 'Entregable5A'};
var $author$project$Route$Entregable5B = {$: 'Entregable5B'};
var $author$project$Route$Entregable6 = {$: 'Entregable6'};
var $author$project$Route$Entregable6A = {$: 'Entregable6A'};
var $author$project$Route$Entregable6B = {$: 'Entregable6B'};
var $author$project$Route$Entregable6C = {$: 'Entregable6C'};
var $author$project$Route$Entregable6D = {$: 'Entregable6D'};
var $author$project$Route$Entregable6E = {$: 'Entregable6E'};
var $author$project$Route$HomepageRoute = {$: 'HomepageRoute'};
...
var $author$project$Route$decode = function (url) {
	return function (parser) {
		return A2(
			$elm$core$Maybe$withDefault,
			$author$project$Route$HomepageRoute,
			A2($elm$url$Url$Parser$parse, parser, url));
	}(
		$elm$url$Url$Parser$oneOf(
			_List_fromArray(
				[
					A2($elm$url$Url$Parser$map, $author$project$Route$HomepageRoute, $elm$url$Url$Parser$top),
					A2(
					$elm$url$Url$Parser$map,
					$author$project$Route$Entregable1,
					$elm$url$Url$Parser$s('entregable1')),
					A2(
					$elm$url$Url$Parser$map,
					$author$project$Route$Entregable2,
					$elm$url$Url$Parser$s('entregable2')),
					A2(
					$elm$url$Url$Parser$map,
					$author$project$Route$Entregable3,
					$elm$url$Url$Parser$s('entregable3')),
					A2(
					$elm$url$Url$Parser$map,
					$author$project$Route$Entregable4,
					$elm$url$Url$Parser$s('entregable4')),
					A2(
					$elm$url$Url$Parser$map,
					$author$project$Route$Entregable5,
					$elm$url$Url$Parser$s('entregable5')),
					A2(
					$elm$url$Url$Parser$map,
					$author$project$Route$Entregable6,
					$elm$url$Url$Parser$s('entregable6')),
					A2(
					$elm$url$Url$Parser$map,
					$author$project$Route$Entregable1A,
					$elm$url$Url$Parser$s('entregable1a')),
					A2(
					$elm$url$Url$Parser$map,
					$author$project$Route$Entregable1B,
					$elm$url$Url$Parser$s('entregable1b')),
					A2(
					$elm$url$Url$Parser$map,
					$author$project$Route$Entregable1C,
					$elm$url$Url$Parser$s('entregable1c')),
					A2(
					$elm$url$Url$Parser$map,
					$author$project$Route$Entregable2A,
					$elm$url$Url$Parser$s('entregable2a')),
					A2(
					$elm$url$Url$Parser$map,
					$author$project$Route$Entregable2B,
					$elm$url$Url$Parser$s('entregable2b')),
					A2(
					$elm$url$Url$Parser$map,
					$author$project$Route$Entregable3A,
					$elm$url$Url$Parser$s('entregable3a')),
					A2(
					$elm$url$Url$Parser$map,
					$author$project$Route$Entregable3B,
					$elm$url$Url$Parser$s('entregable3b')),
					A2(
					$elm$url$Url$Parser$map,
					$author$project$Route$Entregable4A,
					$elm$url$Url$Parser$s('entregable4a')),
					A2(
					$elm$url$Url$Parser$map,
					$author$project$Route$Entregable4B,
					$elm$url$Url$Parser$s('entregable4b')),
					A2(
					$elm$url$Url$Parser$map,
					$author$project$Route$Entregable4C,
					$elm$url$Url$Parser$s('entregable4c')),
					A2(
					$elm$url$Url$Parser$map,
					$author$project$Route$Entregable5A,
					$elm$url$Url$Parser$s('entregable5a')),
					A2(
					$elm$url$Url$Parser$map,
					$author$project$Route$Entregable5B,
					$elm$url$Url$Parser$s('entregable5b')),
					A2(
					$elm$url$Url$Parser$map,
					$author$project$Route$Entregable6A,
					$elm$url$Url$Parser$s('entregable6a')),
					A2(
					$elm$url$Url$Parser$map,
					$author$project$Route$Entregable6B,
					$elm$url$Url$Parser$s('entregable6b')),
					A2(
					$elm$url$Url$Parser$map,
					$author$project$Route$Entregable6C,
					$elm$url$Url$Parser$s('entregable6c')),
					A2(
					$elm$url$Url$Parser$map,
					$author$project$Route$Entregable6D,
					$elm$url$Url$Parser$s('entregable6d')),
					A2(
					$elm$url$Url$Parser$map,
					$author$project$Route$Entregable6E,
					$elm$url$Url$Parser$s('entregable6e'))
				])));
};
...
var $author$project$Types$Entregable = F6(
	function (codigo, route, descripcionEntregable, tipoEvidencia, tituloEntregable, vistaEntregable) {
		return {codigo: codigo, descripcionEntregable: descripcionEntregable, route: route, tipoEvidencia: tipoEvidencia, tituloEntregable: tituloEntregable, vistaEntregable: vistaEntregable};
	});
...
var $author$project$Entregables$Titulos$titulo = function (code) {
	switch (code) {
		case 'E1':
			return '1 Compromiso profesional';
		case 'E1A':
			return '1.A Contexto para la comunicación';
		case 'E1B':
			return '1.B Contexto de colaboración';
		case 'E1C':
			return '1.C Netiqueta';
		case 'E2':
			return '2 Contenidos digitales';
		case 'E2A':
			return '2.A Contenido Básico';
		case 'E2B':
			return '2.B Contenido de Profundización';
		case 'E3':
			return '3 Evidencia del Contexto colaborativo del alumnado';
		case 'E3A':
			return '3.A Contexto colaborativo del alumnado';
		case 'E3B':
			return '3.B Puesta a disposición de los recursos';
		case 'E4':
			return '4 Evaluación y retroalimentación';
		case 'E4A':
			return '4.A Evaluación previa';
		case 'E4B':
			return '4.B Evaluación formativa';
		case 'E4C':
			return '4.C Retroalimentación';
		case 'E5':
			return '5 Empoderamiento del alumnado';
		case 'E5A':
			return '5.A Accesibilidad de los contenidos digitales';
		case 'E5B':
			return '5.B Personalización del aprendizaje';
		case 'E6':
			return '6 Trabajo con el alumnado';
		case 'E6A':
			return '6.A: Búsquedas eficacez';
		case 'E6B':
			return '6.B: Definición de normas de comportamiento';
		case 'E6C':
			return '6.C: Desarrollo de contenidos digitales';
		case 'E6D':
			return '6.D: Uso responsable';
		case 'E6E':
			return '6.E: Resolución de problemas digitales';
		case 'Esquema':
			return 'Esquema';
		default:
...
var $author$project$Route$encode = function (route) {
	return A2(
...
var $author$project$Styles$linkBlue = A3($mdgriffith$elm_ui$Element$rgb255, 12, 82, 200);
...
var $author$project$Views$Componentes$breadcrumbs = F2(
	function (d, entregables) {
		var textAttrs = _Utils_ap(
			$author$project$Styles$montserratSemiBold,
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Font$color($author$project$Styles$linkBlue)
				]));
		var link = F2(
			function (route, labelText) {
				return A2(
					...
					_List_Nil,
					{
						...
						url: $author$project$Route$encode(route)
					});
			});
		var routes = A2(
			$elm$core$List$cons,
			A2(link, $author$project$Route$HomepageRoute, 'Esquema'),
			A2(
				$elm$core$List$map,
				function (entregable) {
					if (entregable.$ === 'Just') {
						var _v1 = entregable.a;
						var r = _v1.a;
						var s = _v1.b;
						return A2(link, r, s);
					} else {
		...
		var itemsConBarra = A2(
			$elm$core$List$intersperse,
			$mdgriffith$elm_ui$Element$text('   '),
			A2($elm$core$List$intersperse, contrabarra, routes));
		return A2(
...
var $author$project$MarkdownThemed$lightTheme = {
	defaultText: A3($mdgriffith$elm_ui$Element$rgb255, 30, 50, 46),
	grey: A3($mdgriffith$elm_ui$Element$rgb255, 200, 220, 240),
	lightGrey: A3($mdgriffith$elm_ui$Element$rgb255, 248, 250, 240),
	link: $author$project$Styles$linkBlue,
	mutedText: A3($mdgriffith$elm_ui$Element$rgb255, 74, 94, 122)
};
...
var $author$project$MarkdownThemed$render = F2(
	function (chosenRenderer, markdownBody) {
			...
			return A2(
				...
				function (res) {
					if (res.$ === 'Ok') {
						...
						return _List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text('Something went wrong rendering this page'),
								$mdgriffith$elm_ui$Element$text(err)
							]);
					}
				}(
					A2($dillonkearns$elm_markdown$Markdown$Renderer$render, chosenRenderer, parsed)));
		}(
			A2(
				$elm$core$Result$withDefault,
				_List_Nil,
...
var $author$project$Styles$grisclaro20 = A4($mdgriffith$elm_ui$Element$rgba, 0, 0, 0, 0.2);
var $mdgriffith$elm_ui$Internal$Model$Px = function (a) {
	return {$: 'Px', a: a};
};
var $mdgriffith$elm_ui$Element$px = $mdgriffith$elm_ui$Internal$Model$Px;
var $author$project$Styles$divider = A2(
	$mdgriffith$elm_ui$Element$el,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
			...
			$mdgriffith$elm_ui$Element$Background$color($author$project$Styles$grisclaro20)
		]),
	$mdgriffith$elm_ui$Element$none);
var $author$project$Styles$grisclaro5 = A4($mdgriffith$elm_ui$Element$rgba, 0, 0, 0, 0.05);
...
var $author$project$MarkdownThemed$rawTextToId = function (rawText) {
	return A3(
...
var $author$project$MarkdownThemed$heading = F2(
	function (theme, _v0) {
		var level = _v0.level;
		...
		return A2(
			...
			_Utils_ap(
				function () {
					var _v1 = $dillonkearns$elm_markdown$Markdown$Block$headingLevelToInt(level);
					switch (_v1) {
						case 1:
							return _List_fromArray(
								[
									$mdgriffith$elm_ui$Element$Font$color(theme.defaultText),
				...
				_List_fromArray(
					[
						...
						A2(
							...
							'name',
							$author$project$MarkdownThemed$rawTextToId(rawText))),
						$mdgriffith$elm_ui$Element$htmlAttribute(
...
var $author$project$MarkdownThemed$htmlImageView = A2(
		...
		A2(
			...
			A2(
				...
				A2(
					...
					'img',
					F5(
						function (src, width_, maxWidth_, bg_, content) {
							var attrs = function () {
								if (maxWidth_.$ === 'Just') {
									var maxWidth = maxWidth_.a;
									return _List_fromArray(
										[
											A2(
											$elm$core$Maybe$withDefault,
											...
											A2(
												...
												$elm$core$String$toInt(maxWidth))),
									...
									return _List_fromArray(
										[
											...
											A2(
												...
												A2($elm$core$Maybe$andThen, $elm$core$String$toInt, width_)))
										]);
								}
							}();
							if (bg_.$ === 'Just') {
...
var $author$project$MarkdownThemed$justs = A2(
	$elm$core$List$foldl,
	F2(
		function (v, acc) {
			if (v.$ === 'Just') {
				var el = v.a;
				return A2($elm$core$List$cons, el, acc);
			} else {
				return acc;
			}
		}),
...
var $author$project$MarkdownThemed$renderer = function (theme) {
	return {
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$Border$color(theme.grey),
						$mdgriffith$elm_ui$Element$Font$color(theme.mutedText),
		...
		codeBlock: function (_v0) {
			...
			var numberOfLines = $elm$core$Basics$round(
				function (x) {
					return 1.35 * x;
				}(
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$paddingEach(
						{bottom: 20, left: 0, right: 0, top: 8}),
						$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
						$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$shrink),
						$mdgriffith$elm_ui$Element$htmlAttribute(
						$elm$html$Html$Attributes$class('preserve-white-space')),
						$mdgriffith$elm_ui$Element$htmlAttribute(
						A2($elm$html$Html$Attributes$style, 'line-height', '1.8')),
						$mdgriffith$elm_ui$Element$scrollbarX,
						$mdgriffith$elm_ui$Element$Background$color($author$project$Styles$grisclaro5)
					]),
				_List_fromArray(
					[
						A2(
						...
						$mdgriffith$elm_ui$Element$html(
							A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class(languageClass)
									]),
								_List_fromArray(
									[
		...
		codeSpan: function (content) {
			return $mdgriffith$elm_ui$Element$html(
				A2(
					...
					_List_fromArray(
						[
							A2($elm$html$Html$Attributes$style, 'color', '#220cb0')
						]),
					_List_fromArray(
						[
		...
		heading: function (data) {
			return A2(
				...
				_List_fromArray(
					[
						A2($author$project$MarkdownThemed$heading, theme, data)
					]));
		},
		html: $dillonkearns$elm_markdown$Markdown$Html$oneOf(
			_List_fromArray(
				[
					$author$project$MarkdownThemed$htmlImageView,
					A2(
					$dillonkearns$elm_markdown$Markdown$Html$tag,
					'br',
					function (_v2) {
		...
		image: function (_v3) {
			...
			var src = _v3.src;
			var title = _v3.title;
			var attrs = $author$project$MarkdownThemed$justs(
				_List_fromArray(
					[
						A2(
						$elm$core$Maybe$map,
						function (title_) {
							return $mdgriffith$elm_ui$Element$htmlAttribute(
								A2($elm$html$Html$Attributes$attribute, 'title', title_));
						},
						title),
						$elm$core$Maybe$Just(
						$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)),
		...
		link: F2(
			function (_v4, list) {
				var title = _v4.title;
				var destination = _v4.destination;
				return A2(
					$mdgriffith$elm_ui$Element$link,
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$Font$underline,
							$mdgriffith$elm_ui$Element$Font$color(theme.link)
						]),
					{
						label: function () {
							if (title.$ === 'Just') {
								var title_ = title.a;
								return $mdgriffith$elm_ui$Element$text(title_);
							} else {
								return A2($mdgriffith$elm_ui$Element$paragraph, _List_Nil, list);
							}
						}(),
						url: destination
					});
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
							$mdgriffith$elm_ui$Element$paddingEach(
							{bottom: 40, left: 0, right: 0, top: 10})
						]),
					A2(
						$elm$core$List$indexedMap,
						F2(
									...
									_List_fromArray(
										[
											...
											A2(
												$elm$core$List$cons,
												$mdgriffith$elm_ui$Element$text(
													$elm$core$String$fromInt(startingIndex + index) + '. '),
												itemBlocks))
										]));
							}),
						items));
		...
		tableBody: function (children) {
			return A2($mdgriffith$elm_ui$Element$column, _List_Nil, children);
		},
		tableCell: F2(
			function (_v6, children) {
				return A2(
					$mdgriffith$elm_ui$Element$column,
					_List_fromArray(
						[
		...
		tableHeader: function (children) {
			return A2($mdgriffith$elm_ui$Element$column, _List_Nil, children);
		},
		tableHeaderCell: F2(
			function (_v7, children) {
				return A2(
					$mdgriffith$elm_ui$Element$column,
					_List_fromArray(
						[
		...
		thematicBreak: $author$project$Styles$divider,
...
var $author$project$MarkdownThemed$renderFull = function (markdownBody) {
	return A2(
		$author$project$MarkdownThemed$render,
		$author$project$MarkdownThemed$renderer($author$project$MarkdownThemed$lightTheme),
		markdownBody);
};
...
var $author$project$Views$Componentes$videoView = F2(
	function (d, src) {
		var w = $elm$core$Basics$round(d.width * 0.9);
		var proportions = 315 / 560;
		var maxw = 1000;
		var maxH = $elm$core$Basics$round(maxw * proportions);
		var h = $elm$core$Basics$round(w * proportions);
		return $mdgriffith$elm_ui$Element$html(
			A2(
				$elm$html$Html$div,
				_List_Nil,
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$style,
								'max-width',
								$elm$core$String$fromInt(maxw) + 'px'),
								$elm$html$Html$Attributes$height(h),
								A2(
								$elm$html$Html$Attributes$style,
								'max-height',
								$elm$core$String$fromInt(maxH) + 'px'),
								$elm$html$Html$Attributes$src(src),
								A2($elm$html$Html$Attributes$attribute, 'title', 'YouTube video player'),
...
var $author$project$Entregables$Entregable1$content = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
...
var $author$project$Styles$grisclaroHex = '#aaaaaa';
...
var $author$project$Styles$leftArrowSvg = F2(
	function (attrs, color) {
		return A2(
			$mdgriffith$elm_ui$Element$el,
			attrs,
			$mdgriffith$elm_ui$Element$html(
				A2($author$project$Styles$arrowSvg, color, '180')));
	});
...
var $author$project$Views$Componentes$footerNavigation = F3(
	function (d, prev, next) {
		var textAttrs = _Utils_ap(
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Font$color($author$project$Styles$linkBlue),
			...
			(d.width < 700) ? $author$project$Styles$montserratSemi : $author$project$Styles$montserratBold);
		var rowAttrs = function (route) {
			return _Utils_ap(
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
			...
			if (prev.$ === 'Just') {
				...
				return A2(
					...
					_List_fromArray(
						[
							A2(
							$author$project$Styles$leftArrowSvg,
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$height(
									$mdgriffith$elm_ui$Element$px(20))
								]),
							$author$project$Styles$grisclaroHex),
							A2(
							$mdgriffith$elm_ui$Element$paragraph,
							textAttrs,
							_List_fromArray(
				...
				return A2(
					...
					_List_fromArray(
						[
							A2(
							$mdgriffith$elm_ui$Element$paragraph,
							A2($elm$core$List$cons, $mdgriffith$elm_ui$Element$Font$alignRight, textAttrs),
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$text(t)
								])),
		...
		return A2(
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$spacing(20),
					$mdgriffith$elm_ui$Element$paddingEach(
					{bottom: 20, left: 20, right: 20, top: 150}),
					$mdgriffith$elm_ui$Element$centerX,
					$mdgriffith$elm_ui$Element$width(
					A2(
						$mdgriffith$elm_ui$Element$maximum,
						$elm$core$Basics$round(d.width * 0.95),
						$mdgriffith$elm_ui$Element$fill))
				]),
			_List_fromArray(
				[prevLink, nextLink]));
	});
var $author$project$Entregables$Entregable1$view = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				...
				A2(
					$mdgriffith$elm_ui$Element$maximum,
					$elm$core$Basics$round(d.width * 0.9),
					$mdgriffith$elm_ui$Element$fill))
			]),
		_List_fromArray(
			[
				A2(
				$author$project$Views$Componentes$breadcrumbs,
				d,
				_List_fromArray(
					[
						$elm$core$Maybe$Just(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Entregables$Entregable1A$content(d),
				A3(
				$author$project$Views$Componentes$footerNavigation,
				d,
				$elm$core$Maybe$Just(
				...
				$elm$core$Maybe$Just(
					_Utils_Tuple2(
						$author$project$Route$Entregable1B,
						$author$project$Entregables$Titulos$titulo('E1B'))))
			]));
};
var $author$project$Entregables$Entregable1B$content = function (d) {
	var whatsappWidth = $elm$core$String$fromInt(
		(d.width > 600) ? 600 : $elm$core$Basics$round(d.width * 0.9));
...
var $author$project$Entregables$Entregable1B$view = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$author$project$Entregables$Entregable1B$content(d),
				A3(
				$author$project$Views$Componentes$footerNavigation,
				d,
				$elm$core$Maybe$Just(
				...
				$elm$core$Maybe$Just(
					_Utils_Tuple2(
						$author$project$Route$Entregable1C,
						$author$project$Entregables$Titulos$titulo('E1C'))))
			]));
};
var $author$project$Entregables$Entregable1C$content = function (d) {
	return $author$project$MarkdownThemed$renderFull('\r\n\r\n# 1.C Normas de netiqueta\r\n\r\n![infografia netiqueta](assets/1CInfografia.svg)\r\n\r\n');
};
var $author$project$Entregables$Entregable1C$view = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$author$project$Entregables$Entregable1C$content(d),
				A3(
				$author$project$Views$Componentes$footerNavigation,
				d,
				$elm$core$Maybe$Just(
				...
				$elm$core$Maybe$Just(
					_Utils_Tuple2(
						$author$project$Route$Entregable2,
						$author$project$Entregables$Titulos$titulo('E2'))))
			]));
};
var $author$project$Entregables$Entregable2$content = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2($author$project$Views$Componentes$videoView, d, 'https://www.youtube.com/embed/KD2d2vpqkSo?si=wI2hyvcu6D0lH2J0')
			]));
};
var $author$project$Entregables$Entregable2$view = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$author$project$Entregables$Entregable2$content(d),
				A3(
				$author$project$Views$Componentes$footerNavigation,
				d,
				$elm$core$Maybe$Just(
				...
				$elm$core$Maybe$Just(
					_Utils_Tuple2(
						$author$project$Route$Entregable2A,
						$author$project$Entregables$Titulos$titulo('E2A'))))
			]));
};
var $author$project$Entregables$Entregable2A$content = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
						$mdgriffith$elm_ui$Element$htmlAttribute(
						$elm$html$Html$Attributes$id('2A-pregunta-1'))
					]),
				$mdgriffith$elm_ui$Element$none),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
						$mdgriffith$elm_ui$Element$htmlAttribute(
						$elm$html$Html$Attributes$id('fill-in-the-blanks-19'))
					]),
				$mdgriffith$elm_ui$Element$none)
			]));
};
var $author$project$Entregables$Entregable2A$view = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$author$project$Entregables$Entregable2A$content(d),
				A3(
				$author$project$Views$Componentes$footerNavigation,
				d,
				$elm$core$Maybe$Just(
				...
				$elm$core$Maybe$Just(
					_Utils_Tuple2(
						$author$project$Route$Entregable2B,
						$author$project$Entregables$Titulos$titulo('E2B'))))
			]));
};
var $author$project$Types$OpenModal = function (a) {
...
var $author$project$Entregables$Entregable2B$content = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Types$OpenModal('diagramaEngrande'))
					]),
				{description: 'Icono para ampliar diagrama.', src: 'assets/fullscreen.svg'}),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
						$mdgriffith$elm_ui$Element$htmlAttribute(
						$elm$html$Html$Attributes$id('decision-tree'))
					]),
				$mdgriffith$elm_ui$Element$none),
...
var $author$project$Entregables$Entregable2B$view = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$author$project$Entregables$Entregable2B$content(d),
				A3(
				$author$project$Views$Componentes$footerNavigation,
				d,
				$elm$core$Maybe$Just(
				...
				$elm$core$Maybe$Just(
					_Utils_Tuple2(
						$author$project$Route$Entregable3,
						$author$project$Entregables$Titulos$titulo('E3'))))
			]));
};
var $author$project$Entregables$Entregable3$content = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2($author$project$Views$Componentes$videoView, d, 'https://www.youtube.com/embed/60UrkJMkj9Q?si=bQawUGP1KJuL9BIH')
			]));
};
var $author$project$Entregables$Entregable3$view = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$author$project$Entregables$Entregable3$content(d),
				A3(
				$author$project$Views$Componentes$footerNavigation,
				d,
				$elm$core$Maybe$Just(
				...
				$elm$core$Maybe$Just(
					_Utils_Tuple2(
						$author$project$Route$Entregable3A,
						$author$project$Entregables$Titulos$titulo('E3A'))))
			]));
};
var $author$project$Entregables$Entregable3A$content = function (d) {
...
var $author$project$Entregables$Entregable3A$view = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$author$project$Entregables$Entregable3A$content(d),
				A3(
				$author$project$Views$Componentes$footerNavigation,
				d,
				$elm$core$Maybe$Just(
				...
				$elm$core$Maybe$Just(
					_Utils_Tuple2(
						$author$project$Route$Entregable3B,
						$author$project$Entregables$Titulos$titulo('E3B'))))
			]));
};
var $author$project$Entregables$Entregable3B$content = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2($author$project$Views$Componentes$videoView, d, 'https://www.youtube.com/embed/qHZ4tY08wsk?si=jxkNXdabunRK_3T-')
			]));
};
var $author$project$Entregables$Entregable3B$view = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$author$project$Entregables$Entregable3B$content(d),
				A3(
				$author$project$Views$Componentes$footerNavigation,
				d,
				$elm$core$Maybe$Just(
				...
				$elm$core$Maybe$Just(
					_Utils_Tuple2(
						$author$project$Route$Entregable4,
						$author$project$Entregables$Titulos$titulo('E4'))))
			]));
};
var $author$project$Entregables$Entregable4$content = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2($author$project$Views$Componentes$videoView, d, 'https://www.youtube.com/embed/IkdFbLRZMNs?si=vUKlzMbZBIi9W-a')
			]));
};
var $author$project$Entregables$Entregable4$view = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$author$project$Entregables$Entregable4$content(d),
				A3(
				$author$project$Views$Componentes$footerNavigation,
				d,
				$elm$core$Maybe$Just(
				...
				$elm$core$Maybe$Just(
					_Utils_Tuple2(
						$author$project$Route$Entregable4A,
						$author$project$Entregables$Titulos$titulo('E4A'))))
			]));
};
var $author$project$Entregables$Entregable4A$content = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_Nil,
		_List_fromArray(
			[
				...
				A2($author$project$Views$Componentes$videoView, d, 'https://www.youtube.com/embed/hNg9d6tfjJ0?si=Vi-TOMIWXIiQ008Q')
			]));
};
var $author$project$Entregables$Entregable4A$view = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$author$project$Entregables$Entregable4A$content(d),
				A3(
				$author$project$Views$Componentes$footerNavigation,
				d,
				$elm$core$Maybe$Just(
				...
				$elm$core$Maybe$Just(
					_Utils_Tuple2(
						$author$project$Route$Entregable4B,
						$author$project$Entregables$Titulos$titulo('E4B'))))
			]));
};
var $author$project$Entregables$Entregable4B$content = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$paddingEach(
						{bottom: 70, left: 0, right: 0, top: 5})
					]),
				A2($author$project$Views$Componentes$videoView, d, 'https://www.youtube.com/embed/IkdFbLRZMNs?si=vUKlzMbZBIi9W-a')),
...
var $author$project$Entregables$Entregable4B$view = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$author$project$Entregables$Entregable4B$content(d),
				A3(
				$author$project$Views$Componentes$footerNavigation,
				d,
				$elm$core$Maybe$Just(
				...
				$elm$core$Maybe$Just(
					_Utils_Tuple2(
						$author$project$Route$Entregable4C,
						$author$project$Entregables$Titulos$titulo('E4C'))))
			]));
};
var $author$project$Lottie$viewWip = A2(
	$mdgriffith$elm_ui$Element$el,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$centerX,
			...
			$mdgriffith$elm_ui$Element$padding(10),
			$mdgriffith$elm_ui$Element$htmlAttribute(
			A2($elm$html$Html$Attributes$style, 'filter', 'saturate(1.1)'))
		]),
	A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$htmlAttribute(
				$elm$html$Html$Attributes$id('wip-animation')),
				$mdgriffith$elm_ui$Element$width(
		...
		$mdgriffith$elm_ui$Element$none));
var $author$project$Views$Componentes$wip = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$text('Work in progress...')),
				A2($mdgriffith$elm_ui$Element$el, _List_Nil, $mdgriffith$elm_ui$Element$none),
				A2($mdgriffith$elm_ui$Element$el, _List_Nil, $mdgriffith$elm_ui$Element$none),
				A2($mdgriffith$elm_ui$Element$el, _List_Nil, $mdgriffith$elm_ui$Element$none)
			]));
};
var $author$project$Entregables$Entregable4C$content = function (d) {
	return $author$project$Views$Componentes$wip(d);
};
var $author$project$Entregables$Entregable4C$view = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$author$project$Entregables$Entregable4C$content(d),
				A3(
				$author$project$Views$Componentes$footerNavigation,
				d,
				$elm$core$Maybe$Just(
				...
				$elm$core$Maybe$Just(
					_Utils_Tuple2(
						$author$project$Route$Entregable5,
						$author$project$Entregables$Titulos$titulo('E5'))))
			]));
};
var $author$project$Entregables$Entregable5$content = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
...
var $author$project$Entregables$Entregable5$view = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$author$project$Entregables$Entregable5$content(d),
				A3(
				$author$project$Views$Componentes$footerNavigation,
				d,
				$elm$core$Maybe$Just(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Entregables$Entregable5A$content(d),
				A3(
				$author$project$Views$Componentes$footerNavigation,
				d,
				$elm$core$Maybe$Just(
				...
				$elm$core$Maybe$Just(
					_Utils_Tuple2(
						$author$project$Route$Entregable5B,
						$author$project$Entregables$Titulos$titulo('E5B'))))
			]));
};
var $author$project$Entregables$Entregable5B$headerRow = A2(
	$mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			...
			$mdgriffith$elm_ui$Element$text('Alumno/a')),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			$mdgriffith$elm_ui$Element$text('Nº')),
			A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			$mdgriffith$elm_ui$Element$text('Visitas'))
		]));
var $author$project$Entregables$Entregable5B$rowView = function (r) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$text(
					$elm$core$String$fromInt(
						$elm$core$Basics$round(r.visitas))))
			]));
};
var $author$project$Entregables$Entregable5B$rows = _List_fromArray(
	[
		{num: 1.0, visitas: 2.0},
		{num: 2.0, visitas: 5.0},
		{num: 3.0, visitas: 2.0},
...
var $author$project$Entregables$Entregable5B$table = A2(
	$mdgriffith$elm_ui$Element$column,
	_List_fromArray(
		[
	...
	A2(
		$elm$core$List$cons,
		$author$project$Entregables$Entregable5B$headerRow,
		A2($elm$core$List$map, $author$project$Entregables$Entregable5B$rowView, $author$project$Entregables$Entregable5B$rows)));
var $author$project$Entregables$Entregable5B$content = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_Nil,
		_List_fromArray(
			[
				...
				$author$project$Entregables$Entregable5B$table,
...
var $author$project$Entregables$Entregable5B$view = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$author$project$Entregables$Entregable5B$content(d),
				A3(
				$author$project$Views$Componentes$footerNavigation,
				d,
				$elm$core$Maybe$Just(
				...
				$elm$core$Maybe$Just(
					_Utils_Tuple2(
						$author$project$Route$Entregable6,
						$author$project$Entregables$Titulos$titulo('E6'))))
			]));
};
var $author$project$Entregables$Entregable6$content = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2($author$project$Views$Componentes$videoView, d, 'https://www.youtube.com/embed/zXWcOIMMTJw?si=6m5Fplmbm-poLbe_')
			]));
};
var $author$project$Entregables$Entregable6$view = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$author$project$Entregables$Entregable6$content(d),
				A3(
				$author$project$Views$Componentes$footerNavigation,
				d,
				$elm$core$Maybe$Just(
				...
				$elm$core$Maybe$Just(
					_Utils_Tuple2(
						$author$project$Route$Entregable6A,
						$author$project$Entregables$Titulos$titulo('E6A'))))
			]));
};
var $author$project$Entregables$Entregable6A$content = function (d) {
...
var $author$project$Entregables$Entregable6A$view = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$author$project$Entregables$Entregable6A$content(d),
				A3(
				$author$project$Views$Componentes$footerNavigation,
				d,
				$elm$core$Maybe$Just(
				...
				$elm$core$Maybe$Just(
					_Utils_Tuple2(
						$author$project$Route$Entregable6B,
						$author$project$Entregables$Titulos$titulo('E6B'))))
			]));
};
var $author$project$Entregables$Entregable6B$content = function (d) {
...
var $author$project$Entregables$Entregable6B$view = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$author$project$Entregables$Entregable6B$content(d),
				A3(
				$author$project$Views$Componentes$footerNavigation,
				d,
				$elm$core$Maybe$Just(
				...
				$elm$core$Maybe$Just(
					_Utils_Tuple2(
						$author$project$Route$Entregable6C,
						$author$project$Entregables$Titulos$titulo('E6C'))))
			]));
};
var $author$project$Entregables$Entregable6C$content = function (d) {
...
var $author$project$Entregables$Entregable6C$view = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$author$project$Entregables$Entregable6C$content(d),
				A3(
				$author$project$Views$Componentes$footerNavigation,
				d,
				$elm$core$Maybe$Just(
				...
				$elm$core$Maybe$Just(
					_Utils_Tuple2(
						$author$project$Route$Entregable6D,
						$author$project$Entregables$Titulos$titulo('E6D'))))
			]));
};
var $author$project$Entregables$Entregable6D$content = function (d) {
...
var $author$project$Entregables$Entregable6D$view = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$author$project$Entregables$Entregable6D$content(d),
				A3(
				$author$project$Views$Componentes$footerNavigation,
				d,
				$elm$core$Maybe$Just(
				...
				$elm$core$Maybe$Just(
					_Utils_Tuple2(
						$author$project$Route$Entregable6E,
						$author$project$Entregables$Titulos$titulo('E6E'))))
			]));
};
var $author$project$Entregables$Entregable6E$content = function (d) {
...
var $author$project$Entregables$Entregable6E$view = function (d) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$author$project$Entregables$Entregable6E$content(d),
				A3(
				$author$project$Views$Componentes$footerNavigation,
				d,
				$elm$core$Maybe$Just(
...
var $author$project$Entregables$Entregables$entregables = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2(
			'1',
			A6(
				$author$project$Types$Entregable,
				'1',
				$author$project$Route$Entregable1,
				'Compromiso profesional',
				$elm$core$Maybe$Just('video'),
				$author$project$Entregables$Titulos$titulo('E1'),
				$author$project$Entregables$Entregable1$view)),
			_Utils_Tuple2(
			'2',
			A6(
				$author$project$Types$Entregable,
				...
				$elm$core$Maybe$Just('video'),
				$author$project$Entregables$Titulos$titulo('E2'),
				$author$project$Entregables$Entregable2$view)),
			_Utils_Tuple2(
			'3',
			A6(
				$author$project$Types$Entregable,
				...
				$elm$core$Maybe$Just('video'),
				$author$project$Entregables$Titulos$titulo('E3'),
				$author$project$Entregables$Entregable3$view)),
			_Utils_Tuple2(
			'4',
			A6(
				$author$project$Types$Entregable,
				...
				$elm$core$Maybe$Just('video'),
				$author$project$Entregables$Titulos$titulo('E4'),
				$author$project$Entregables$Entregable4$view)),
			_Utils_Tuple2(
			'5',
			A6(
				$author$project$Types$Entregable,
				...
				$elm$core$Maybe$Just('video'),
				$author$project$Entregables$Titulos$titulo('E5'),
				$author$project$Entregables$Entregable5$view)),
			_Utils_Tuple2(
			'6',
			A6(
				$author$project$Types$Entregable,
				...
				$elm$core$Maybe$Just('video'),
				$author$project$Entregables$Titulos$titulo('E6'),
				$author$project$Entregables$Entregable6$view)),
			_Utils_Tuple2(
			'1.A',
			A6(
				$author$project$Types$Entregable,
				...
				$author$project$Entregables$Titulos$titulo('E1A'),
				$author$project$Entregables$Entregable1A$view)),
			_Utils_Tuple2(
			'1.B',
			A6(
				$author$project$Types$Entregable,
				...
				$elm$core$Maybe$Just('captura'),
				$author$project$Entregables$Titulos$titulo('E1B'),
				$author$project$Entregables$Entregable1B$view)),
			_Utils_Tuple2(
			'1.C',
			A6(
				$author$project$Types$Entregable,
				...
				$author$project$Entregables$Titulos$titulo('E1C'),
				$author$project$Entregables$Entregable1C$view)),
			_Utils_Tuple2(
			'2.A',
			A6(
				$author$project$Types$Entregable,
				...
				$author$project$Entregables$Titulos$titulo('E2A'),
				$author$project$Entregables$Entregable2A$view)),
			_Utils_Tuple2(
			'2.B',
			A6(
				$author$project$Types$Entregable,
				...
				$elm$core$Maybe$Just('contenido'),
				$author$project$Entregables$Titulos$titulo('E2B'),
				$author$project$Entregables$Entregable2B$view)),
			_Utils_Tuple2(
			'3.A',
			A6(
				$author$project$Types$Entregable,
				...
				$elm$core$Maybe$Nothing,
				$author$project$Entregables$Titulos$titulo('E3A'),
				$author$project$Entregables$Entregable3A$view)),
			_Utils_Tuple2(
			'3.B',
			A6(
				$author$project$Types$Entregable,
				...
				$elm$core$Maybe$Nothing,
				$author$project$Entregables$Titulos$titulo('E3B'),
				$author$project$Entregables$Entregable3B$view)),
			_Utils_Tuple2(
			'4.A',
			A6(
				$author$project$Types$Entregable,
				...
				$elm$core$Maybe$Nothing,
				$author$project$Entregables$Titulos$titulo('E4A'),
				$author$project$Entregables$Entregable4A$view)),
			_Utils_Tuple2(
			'4.B',
			A6(
				$author$project$Types$Entregable,
				...
				$elm$core$Maybe$Nothing,
				$author$project$Entregables$Titulos$titulo('E4B'),
				$author$project$Entregables$Entregable4B$view)),
			_Utils_Tuple2(
			'4.C',
			A6(
				$author$project$Types$Entregable,
				...
				$elm$core$Maybe$Nothing,
				$author$project$Entregables$Titulos$titulo('E4C'),
				$author$project$Entregables$Entregable4C$view)),
			_Utils_Tuple2(
			'5.A',
			A6(
				$author$project$Types$Entregable,
				...
				$elm$core$Maybe$Nothing,
				$author$project$Entregables$Titulos$titulo('E5A'),
				$author$project$Entregables$Entregable5A$view)),
			_Utils_Tuple2(
			'5.B',
			A6(
				$author$project$Types$Entregable,
				...
				$elm$core$Maybe$Nothing,
				$author$project$Entregables$Titulos$titulo('E5B'),
				$author$project$Entregables$Entregable5B$view)),
			_Utils_Tuple2(
			'6.A',
			A6(
				$author$project$Types$Entregable,
				...
				$author$project$Entregables$Titulos$titulo('E6A'),
				$author$project$Entregables$Entregable6A$view)),
			_Utils_Tuple2(
			'6.B',
			A6(
				$author$project$Types$Entregable,
				...
				$elm$core$Maybe$Just('doc'),
				$author$project$Entregables$Titulos$titulo('E6B'),
				$author$project$Entregables$Entregable6B$view)),
			_Utils_Tuple2(
			'6.C',
			A6(
				$author$project$Types$Entregable,
				...
				$elm$core$Maybe$Just('doc'),
				$author$project$Entregables$Titulos$titulo('E6C'),
				$author$project$Entregables$Entregable6C$view)),
			_Utils_Tuple2(
			'6.D',
			A6(
				$author$project$Types$Entregable,
				...
				$elm$core$Maybe$Just('doc'),
				$author$project$Entregables$Titulos$titulo('E6D'),
				$author$project$Entregables$Entregable6D$view)),
			_Utils_Tuple2(
			'6.E',
			A6(
				$author$project$Types$Entregable,
				...
				$elm$core$Maybe$Just('doc'),
				$author$project$Entregables$Titulos$titulo('E6E'),
				$author$project$Entregables$Entregable6E$view))
		]));
...
var $author$project$Entregables$Entregables$getEntregableFromRoute = function (route) {
	return $elm$core$List$head(
		$elm$core$Dict$values(
			A2(
				...
				$author$project$Entregables$Entregables$entregables)));
};
var $author$project$Types$MountH5P = {$: 'MountH5P'};
var $author$project$Main$startH5PContent = A2(
	$elm$core$Task$perform,
	function (_v0) {
		return $author$project$Types$MountH5P;
	},
	$elm$core$Task$succeed(_Utils_Tuple0));
var $author$project$Types$LottieMsg = {$: 'LottieMsg'};
var $author$project$Main$startLottieAnimations = A2(
	$elm$core$Task$perform,
	function (_v0) {
		return $author$project$Types$LottieMsg;
	},
	$elm$core$Task$succeed(_Utils_Tuple0));
var $author$project$Main$init = F3(
	function (dimensions, url, key) {
		var route = $author$project$Route$decode(url);
		var baseModel = {
			device: $mdgriffith$elm_ui$Element$classifyDevice(dimensions),
			dimensions: dimensions,
			entregableTitle: '',
			entregableView: function (d) {
				return $mdgriffith$elm_ui$Element$none;
			},
			entregableVisibility: $author$project$Types$Hidden,
			entregables: $author$project$Entregables$Entregables$entregables,
			hovered: $elm$core$Set$empty,
			key: key,
			menuVisible: $author$project$Types$Hidden,
			modalView: '',
			modalVisibility: $author$project$Types$Hidden,
			pendingCloseMenu: $elm$core$Maybe$Nothing,
			route: route,
			sortOrder: $author$project$Types$Categories
		};
		var _v0 = $author$project$Entregables$Entregables$getEntregableFromRoute(route);
		if (_v0.$ === 'Just') {
			var entregable = _v0.a;
			return _Utils_Tuple2(
				_Utils_update(
					baseModel,
					{entregableTitle: entregable.tituloEntregable, entregableView: entregable.vistaEntregable, entregableVisibility: $author$project$Types$Visible}),
				$elm$core$Platform$Cmd$batch(
					_List_fromArray(
						[$author$project$Main$startH5PContent, $author$project$Main$startLottieAnimations, $author$project$Main$checkMarkdownHighlight])));
		} else {
			return _Utils_Tuple2(
				baseModel,
				$elm$core$Platform$Cmd$batch(
...
var $author$project$Types$DeviceClassified = function (a) {
			...
			[
				...
				F2(
					function (width, height) {
						return $author$project$Types$DeviceClassified(
							{height: height, width: width});
					}))
			]));
};
var $author$project$Types$CloseEntregable = {$: 'CloseEntregable'};
var $author$project$Types$CloseMenu = {$: 'CloseMenu'};
var $author$project$Types$HoverOffAll = {$: 'HoverOffAll'};
var $author$project$Types$NoOp = {$: 'NoOp'};
var $author$project$Types$OpenEntregable = function (a) {
	return {$: 'OpenEntregable', a: a};
};
var $author$project$Lottie$animationids = _List_fromArray(
	['student-animation', 'teaching-animation', 'wip-animation']);
...
var $author$project$Main$cleanH5PContent = A2(
	$elm$core$Task$perform,
	function (_v0) {
...
var $author$project$Main$closeModal = A2(
	$elm$core$Task$perform,
	function (_v0) {
		return $author$project$Types$CloseModal;
	},
	$elm$core$Task$succeed(_Utils_Tuple0));
var $elm$browser$Browser$Dom$getElement = _Browser_getElement;
var $author$project$H5P$h5pIds = _List_fromArray(
	['decision-tree', '2A-pregunta-1', 'fill-in-the-blanks-19']);
var $author$project$Main$highlight = _Platform_outgoingPort('highlight', $elm$json$Json$Encode$string);
var $elm$browser$Browser$Navigation$load = _Browser_load;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Main$playLottie = _Platform_outgoingPort(
	'playLottie',
...
var $author$project$Main$requestH5PCleanup = _Platform_outgoingPort(
	'requestH5PCleanup',
	$elm$json$Json$Encode$list($elm$json$Json$Encode$string));
var $author$project$Main$requestH5PInit = _Platform_outgoingPort(
	'requestH5PInit',
	$elm$json$Json$Encode$list($elm$json$Json$Encode$string));
		...
		switch (msg.$) {
						...
						$elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									...
									$author$project$Main$startLottieAnimations,
									$author$project$Main$checkMarkdownHighlight,
			...
			case 'UrlChanged':
				...
				var scrollCmd = function () {
					var _v5 = url.fragment;
					if (_v5.$ === 'Just') {
						var fragmentId = _v5.a;
						return A2(
							...
							A2(
								$elm$core$Task$andThen,
								function (elem) {
									return A2($elm$browser$Browser$Dom$setViewport, 0, elem.element.y - (elem.element.height + 20));
								},
								$elm$browser$Browser$Dom$getElement(fragmentId)));
					} else {
						return $author$project$Main$scrollToTop;
					}
				}();
				var newRoute = $author$project$Route$decode(url);
				var _v2 = $author$project$Entregables$Entregables$getEntregableFromRoute(newRoute);
				if (_v2.$ === 'Just') {
					var entregable = _v2.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{route: newRoute}),
						$elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									...
									$elm$core$Task$perform,
									function (_v3) {
										return $author$project$Types$OpenEntregable(entregable);
									},
									$elm$core$Task$succeed(_Utils_Tuple0)),
									scrollCmd,
									$author$project$Main$startLottieAnimations,
									$author$project$Main$cleanH5PContent,
									$author$project$Main$startH5PContent,
									$author$project$Main$checkMarkdownHighlight
								])));
				} else {
					return _Utils_Tuple2(
						...
						$elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									...
									$elm$core$Task$perform,
									function (_v4) {
										return $author$project$Types$CloseEntregable;
									},
									$elm$core$Task$succeed(_Utils_Tuple0)),
									$author$project$Main$startLottieAnimations,
									$author$project$Main$cleanH5PContent
			...
			case 'HoverOffMany':
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 'OpenEntregable':
				var entregable = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{entregableTitle: entregable.tituloEntregable, entregableView: entregable.vistaEntregable, entregableVisibility: $author$project$Types$Visible}),
					$elm$core$Platform$Cmd$none);
			case 'CloseEntregable':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
					...
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								...
								$elm$core$Task$perform,
								$elm$core$Basics$identity,
								$elm$core$Task$succeed($author$project$Types$HoverOffAll))
							])));
			case 'OpenModal':
				var modal = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{modalView: modal, modalVisibility: $author$project$Types$Visible}),
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[$author$project$Main$startLottieAnimations, $author$project$Main$cleanH5PContent, $author$project$Main$startH5PContent, $author$project$Main$checkMarkdownHighlight])));
			case 'CloseModal':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{modalView: '', modalVisibility: $author$project$Types$Hidden}),
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								A2(
			...
			case 'GoTo':
				...
				return _Utils_Tuple2(
					...
					A2(
						$elm$browser$Browser$Navigation$pushUrl,
						model.key,
						$author$project$Route$encode(route)));
			case 'OpenMenu':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							menuVisible: $author$project$Types$Visible,
							pendingCloseMenu: A2(
								$elm$core$Maybe$map,
								function (_v6) {
									return 2;
								},
								model.pendingCloseMenu)
						}),
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[$author$project$Main$scrollToTop])));
			case 'CloseMenu':
				var menuVis = function () {
					var _v7 = model.pendingCloseMenu;
					if (_v7.$ === 'Just') {
						var id = _v7.a;
						return (id === 1) ? $author$project$Types$Hidden : $author$project$Types$Visible;
					} else {
						return $author$project$Types$Hidden;
					}
				}();
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{menuVisible: menuVis, pendingCloseMenu: $elm$core$Maybe$Nothing}),
					$elm$core$Platform$Cmd$batch(_List_Nil));
			case 'ScheduleClose':
				var cmd = A2(
					$elm$core$Task$perform,
					function (pid) {
						return $author$project$Types$CloseMenu;
					},
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							pendingCloseMenu: $elm$core$Maybe$Just(1)
						}),
					cmd);
			case 'LottieMsg':
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								$author$project$Main$playLottie($author$project$Lottie$animationids)
							])));
			case 'MountH5P':
				return _Utils_Tuple2(
					model,
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								$author$project$Main$requestH5PInit($author$project$H5P$h5pIds)
							])));
			case 'CleanH5PContent':
				return _Utils_Tuple2(
					model,
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								$author$project$Main$requestH5PCleanup($author$project$H5P$h5pIds)
							])));
			default:
				return _Utils_Tuple2(
					model,
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								$author$project$Main$highlight('code')
							])));
		}
	});
var $author$project$Types$HoverOffMany = function (a) {
	return {$: 'HoverOffMany', a: a};
};
var $author$project$Types$HoverOnMany = function (a) {
...
var $author$project$Entregables$Entregables$colorFromCode = function (code) {
	...
	if (_v0.$ === 'Just') {
		...
		switch (c.valueOf()) {
			case '1':
				return $author$project$Styles$naranja;
			case '2':
				return $author$project$Styles$turquesa;
			case '3':
				return $author$project$Styles$azul;
			case '4':
				return $author$project$Styles$limon;
			case '5':
				return $author$project$Styles$chicle;
			case '6':
				return $author$project$Styles$rojo;
			default:
				return $author$project$Styles$negro;
		}
	} else {
		return $author$project$Styles$negro;
	}
...
var $author$project$Views$Botones$botonCompetencia = F4(
	function (entregable, entrega, ids, hovered) {
		var color = $author$project$Entregables$Entregables$colorFromCode(entregable.codigo);
		var _v0 = function () {
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Types$HoverOnMany(ids)),
					$mdgriffith$elm_ui$Element$Events$onMouseLeave(
					$author$project$Types$HoverOffMany(ids)),
					$mdgriffith$elm_ui$Element$inFront(
					A2(
						$mdgriffith$elm_ui$Element$link,
						_List_fromArray(
							...
							]),
						{
							...
							url: $author$project$Route$encode(entregable.route)
						}))
				]),
			_List_fromArray(
				[
						...
						[
							...
							_Utils_ap(
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$Font$color(
										A2($author$project$Styles$oscurecer, color, 0.3)),
							...
							_Utils_ap(
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$Font$color(
										A2($author$project$Styles$oscurecer, color, factor)),
										$mdgriffith$elm_ui$Element$Font$shadow(
										{
											blur: 0,
...
var $author$project$Entregables$Entregables$getEntregable = F2(
	function (key, dict) {
		var _v0 = A2($elm$core$Dict$get, key, dict);
		if (_v0.$ === 'Just') {
			var entregable = _v0.a;
			...
			return A6(
				...
				'0',
				$author$project$Route$HomepageRoute,
				'Esto no es un entregable',
				$elm$core$Maybe$Nothing,
				'Esta pagina no debería verse',
				function (d) {
					return $mdgriffith$elm_ui$Element$none;
				});
		}
...
var $author$project$Entregables$Entregables$secciones = function () {
	var dictEntregables = $author$project$Entregables$Entregables$entregables;
	return $elm$core$Dict$fromList(
		_List_fromArray(
			[
				...
				'ambitoscompe',
				{
					color: $author$project$Styles$blanco,
					entregables: A2(
						$elm$core$List$map,
						function (e) {
							return A2($author$project$Entregables$Entregables$getEntregable, e, dictEntregables);
						},
						_List_fromArray(
							['1', '2', '3', '4', '5', '6'])),
				...
				'concolab',
				{
					color: $author$project$Styles$azul,
					entregables: A2(
						$elm$core$List$map,
						function (e) {
							return A2($author$project$Entregables$Entregables$getEntregable, e, dictEntregables);
				...
				'ensapre',
				{
					color: $author$project$Styles$limon,
					entregables: A2(
						$elm$core$List$map,
						function (e) {
							return A2($author$project$Entregables$Entregables$getEntregable, e, dictEntregables);
				...
				'preeval',
				{
					color: $author$project$Styles$chicle,
					entregables: A2(
						$elm$core$List$map,
						function (e) {
							return A2($author$project$Entregables$Entregables$getEntregable, e, dictEntregables);
				...
				'conbasico',
				{
					color: $author$project$Styles$naranja,
					entregables: A2(
						$elm$core$List$map,
						function (e) {
							return A2($author$project$Entregables$Entregables$getEntregable, e, dictEntregables);
				...
				'colabalumn',
				{
					color: $author$project$Styles$turquesa,
					entregables: A2(
						$elm$core$List$map,
						function (e) {
							return A2($author$project$Entregables$Entregables$getEntregable, e, dictEntregables);
...
var $author$project$Entregables$Entregables$getSeccionByCode = function (code) {
	var secc = $author$project$Entregables$Entregables$secciones;
	var _v0 = A2($elm$core$Dict$get, code, secc);
	if (_v0.$ === 'Just') {
		var sec = _v0.a;
		return sec;
	} else {
		return {color: $author$project$Styles$negro, entregables: _List_Nil, titulo: 'esta seccion no es valida'};
	}
};
var $author$project$Views$DesktopView$aside = function (model) {
	var seccion = $author$project$Entregables$Entregables$getSeccionByCode('ambitoscompe');
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$el,
						$author$project$Styles$montserratBold,
						$mdgriffith$elm_ui$Element$text(seccion.titulo))
					])),
				A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
				...
				_List_fromArray(
					[
						A4(
						$author$project$Views$Botones$botonCompetencia,
						A2($author$project$Entregables$Entregables$getEntregable, '1', model.entregables),
						'1a entrega',
						_List_fromArray(
							[100, 1, 2, 3]),
						model.hovered),
						A4(
						$author$project$Views$Botones$botonCompetencia,
						A2($author$project$Entregables$Entregables$getEntregable, '2', model.entregables),
						'2a entrega',
						_List_fromArray(
							[101, 8, 10]),
						model.hovered),
						A4(
						$author$project$Views$Botones$botonCompetencia,
						A2($author$project$Entregables$Entregables$getEntregable, '3', model.entregables),
						'4a entrega',
						_List_fromArray(
							[102, 4, 5]),
						model.hovered),
						A4(
						$author$project$Views$Botones$botonCompetencia,
						A2($author$project$Entregables$Entregables$getEntregable, '4', model.entregables),
						'6a entrega',
						_List_fromArray(
							[103, 6, 18, 19]),
						model.hovered),
						A4(
						$author$project$Views$Botones$botonCompetencia,
						A2($author$project$Entregables$Entregables$getEntregable, '5', model.entregables),
						'3a entrega',
						_List_fromArray(
							[104, 9, 11, 12]),
						model.hovered),
						A4(
						$author$project$Views$Botones$botonCompetencia,
						A2($author$project$Entregables$Entregables$getEntregable, '6', model.entregables),
						'5a entrega',
						_List_fromArray(
							[105, 13, 14, 15, 16, 17]),
						model.hovered)
...
var $author$project$Views$DesktopView$asideEvidencias = function () {
...
var $author$project$Types$HoverOff = function (a) {
	return {$: 'HoverOff', a: a};
};
var $author$project$Types$HoverOn = function (a) {
	return {$: 'HoverOn', a: a};
};
...
var $author$project$Views$Botones$botonEntregable = F3(
	function (entregable, id, hovered) {
				...
				_Utils_ap(
					...
					_List_fromArray(
						[
							...
							$author$project$Entregables$Entregables$colorFromCode(entregable.codigo)),
							$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
							$mdgriffith$elm_ui$Element$height(
							$mdgriffith$elm_ui$Element$px(60)),
							$mdgriffith$elm_ui$Element$padding(10),
							...
							$mdgriffith$elm_ui$Element$pointer,
							$mdgriffith$elm_ui$Element$Events$onMouseEnter(
							$author$project$Types$HoverOn(id)),
							$mdgriffith$elm_ui$Element$Events$onMouseLeave(
							$author$project$Types$HoverOff(id)),
...
var $author$project$Views$DesktopView$contenidoProfundizacion = function (model) {
	var seccion = $author$project$Entregables$Entregables$getSeccionByCode('conprofund');
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_Utils_ap(
			$author$project$Styles$borderStyle,
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Background$color(seccion.color),
					$mdgriffith$elm_ui$Element$padding(15),
					$mdgriffith$elm_ui$Element$spacing(10)
				])),
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A3(
						$author$project$Views$Botones$botonEntregable,
						A2($author$project$Entregables$Entregables$getEntregable, '2.B', model.entregables),
						10,
						model.hovered),
						A3(
						$author$project$Views$Botones$botonEntregable,
						A2($author$project$Entregables$Entregables$getEntregable, '5.A', model.entregables),
						11,
						model.hovered),
						A3(
						$author$project$Views$Botones$botonEntregable,
						A2($author$project$Entregables$Entregables$getEntregable, '5.B', model.entregables),
						12,
						model.hovered)
					]))
			]));
...
var $author$project$Views$DesktopView$contenidoBasico = function (model) {
	var seccion = $author$project$Entregables$Entregables$getSeccionByCode('conbasico');
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						A3(
						$author$project$Views$Botones$botonEntregable,
						A2($author$project$Entregables$Entregables$getEntregable, '2.A', model.entregables),
						8,
						model.hovered),
						A3(
						$author$project$Views$Botones$botonEntregable,
...
var $author$project$Views$DesktopView$preguntaFlujo = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
...
var $author$project$Views$DesktopView$contenidos = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Views$DesktopView$preguntaFlujo(model),
				$author$project$Views$DesktopView$contenidoBasico(model)
			]));
};
var $author$project$Views$DesktopView$contextoColaborativoAlumnado = function (model) {
	var seccion = $author$project$Entregables$Entregables$getSeccionByCode('colabalumn');
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_Utils_ap(
			$author$project$Styles$borderStyle,
			...
			[
				...
				_List_fromArray(
					[
						A3(
						$author$project$Views$Botones$botonEntregable,
						A2($author$project$Entregables$Entregables$getEntregable, '6.A', model.entregables),
						13,
						model.hovered),
						A3(
						$author$project$Views$Botones$botonEntregable,
						A2($author$project$Entregables$Entregables$getEntregable, '6.B', model.entregables),
						14,
						model.hovered),
						A3(
						$author$project$Views$Botones$botonEntregable,
						A2($author$project$Entregables$Entregables$getEntregable, '6.C', model.entregables),
						15,
						model.hovered)
					])),
				A2(
				...
				_List_fromArray(
					[
						A3(
						$author$project$Views$Botones$botonEntregable,
						A2($author$project$Entregables$Entregables$getEntregable, '6.D', model.entregables),
						16,
						model.hovered),
						A3(
						$author$project$Views$Botones$botonEntregable,
						A2($author$project$Entregables$Entregables$getEntregable, '6.E', model.entregables),
						17,
						model.hovered)
					]))
			]));
};
var $author$project$Views$DesktopView$evaluacionPrevia = function (model) {
	var seccion = $author$project$Entregables$Entregables$getSeccionByCode('preeval');
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_Utils_ap(
			$author$project$Styles$borderStyle,
		...
		_List_fromArray(
			[
				...
				A3(
				$author$project$Views$Botones$botonEntregable,
				A2($author$project$Entregables$Entregables$getEntregable, '4.A', model.entregables),
				6,
				model.hovered)
			]));
};
var $author$project$Views$DesktopView$evaluacionYRetroalimentacion = function (model) {
	var seccion = $author$project$Entregables$Entregables$getSeccionByCode('evlaretro');
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_Utils_ap(
			$author$project$Styles$borderStyle,
			...
			[
				...
				_List_fromArray(
					[
						A3(
						$author$project$Views$Botones$botonEntregable,
						A2($author$project$Entregables$Entregables$getEntregable, '4.B', model.entregables),
						18,
						model.hovered),
						A3(
						$author$project$Views$Botones$botonEntregable,
						A2($author$project$Entregables$Entregables$getEntregable, '4.C', model.entregables),
						19,
						model.hovered)
					]))
			]));
...
var $author$project$Views$DesktopView$centro = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_Utils_ap(
		...
		_List_fromArray(
			[
				$author$project$Views$DesktopView$evaluacionPrevia(model),
				$author$project$Views$DesktopView$contenidos(model),
				$author$project$Views$DesktopView$contenidoProfundizacion(model),
				$author$project$Views$DesktopView$contextoColaborativoAlumnado(model),
				$author$project$Views$DesktopView$evaluacionYRetroalimentacion(model)
			]));
};
var $author$project$Views$DesktopView$contextoColaborativo = function (model) {
	var seccion = $author$project$Entregables$Entregables$getSeccionByCode('concolab');
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						A3(
						$author$project$Views$Botones$botonEntregable,
						A2($author$project$Entregables$Entregables$getEntregable, '1.A', model.entregables),
						1,
						model.hovered),
						A3(
						$author$project$Views$Botones$botonEntregable,
						A2($author$project$Entregables$Entregables$getEntregable, '1.B', model.entregables),
						2,
						model.hovered),
						A3(
						$author$project$Views$Botones$botonEntregable,
						A2($author$project$Entregables$Entregables$getEntregable, '1.C', model.entregables),
						3,
						model.hovered)
					]))
			]));
};
var $author$project$Views$DesktopView$ensenanzaAprendizaje = function (model) {
	var seccion = $author$project$Entregables$Entregables$getSeccionByCode('ensapre');
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						A3(
						$author$project$Views$Botones$botonEntregable,
						A2($author$project$Entregables$Entregables$getEntregable, '3.A', model.entregables),
						4,
						model.hovered),
						A3(
						$author$project$Views$Botones$botonEntregable,
						A2($author$project$Entregables$Entregables$getEntregable, '3.B', model.entregables),
						5,
						model.hovered)
					]))
			]));
};
var $author$project$Views$DesktopView$mainSection = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_Utils_ap(
			$author$project$Styles$borderStyle,
		...
		_List_fromArray(
			[
				$author$project$Views$DesktopView$contextoColaborativo(model),
				$author$project$Views$DesktopView$centro(model),
				$author$project$Views$DesktopView$ensenanzaAprendizaje(model)
			]));
};
var $author$project$Lottie$viewStudent = A2(
	$mdgriffith$elm_ui$Element$el,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$centerX,
			$mdgriffith$elm_ui$Element$centerY,
			$mdgriffith$elm_ui$Element$padding(10),
			$mdgriffith$elm_ui$Element$moveDown(290),
			$mdgriffith$elm_ui$Element$moveRight(650),
			$mdgriffith$elm_ui$Element$htmlAttribute(
			A2($elm$html$Html$Attributes$style, 'filter', 'saturate(1.1)'))
		]),
	A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$htmlAttribute(
				$elm$html$Html$Attributes$id('student-animation')),
				$mdgriffith$elm_ui$Element$width(
				$mdgriffith$elm_ui$Element$px(500)),
				$mdgriffith$elm_ui$Element$height(
				$mdgriffith$elm_ui$Element$px(500)),
				$mdgriffith$elm_ui$Element$htmlAttribute(
				A2($elm$html$Html$Attributes$style, 'filter', 'hue-rotate(30deg)'))
			]),
		$mdgriffith$elm_ui$Element$none));
...
var $author$project$Lottie$viewTeaching = A2(
	$mdgriffith$elm_ui$Element$el,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$centerX,
			...
			$mdgriffith$elm_ui$Element$moveDown(370),
			$mdgriffith$elm_ui$Element$moveLeft(650),
			$mdgriffith$elm_ui$Element$htmlAttribute(
			A2($elm$html$Html$Attributes$style, 'filter', 'saturate(2)'))
		]),
	A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$htmlAttribute(
				$elm$html$Html$Attributes$id('teaching-animation')),
				$mdgriffith$elm_ui$Element$width(
		...
		$mdgriffith$elm_ui$Element$none));
var $author$project$Views$DesktopView$contenido = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$spacing(40),
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$inFront($author$project$Lottie$viewTeaching),
				$mdgriffith$elm_ui$Element$inFront($author$project$Lottie$viewStudent)
			]),
		_List_fromArray(
			[
				$author$project$Views$DesktopView$aside(model),
				$author$project$Views$DesktopView$mainSection(model),
				$author$project$Views$DesktopView$asideEvidencias
			]));
};
var $author$project$Entregables$Entregable2B$diagramaEngrande = A2(
	$mdgriffith$elm_ui$Element$el,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
...
var $author$project$Views$Footer$footer = A2(
	$mdgriffith$elm_ui$Element$column,
	_List_fromArray(
		[
...
var $author$project$Types$OpenMenu = {$: 'OpenMenu'};
...
var $author$project$Views$Header$encabezadoFijado = function (model) {
	var onCliclMenu = _Utils_eq(model.menuVisible, $author$project$Types$Visible) ? $mdgriffith$elm_ui$Element$Events$onClick($author$project$Types$CloseMenu) : $mdgriffith$elm_ui$Element$Events$onClick($author$project$Types$OpenMenu);
	var dropShadowValue = A2($elm$core$Set$member, 532, model.hovered) ? 'drop-shadow(3px 3px 0px black)' : 'none';
	return A2(
			...
			_List_fromArray(
				[
					...
					A2(
						...
						{description: 'Boton de menu', src: 'assets/menu.svg'})),
					A2(
					$mdgriffith$elm_ui$Element$el,
							...
							A2(
									...
									]),
								{
									label: A2(
										...
										$mdgriffith$elm_ui$Element$text('Inicio')),
									url: $author$project$Route$encode($author$project$Route$HomepageRoute)
								})),
							$mdgriffith$elm_ui$Element$Events$onMouseEnter(
							$author$project$Types$HoverOn(532)),
							$mdgriffith$elm_ui$Element$Events$onMouseLeave(
							$author$project$Types$HoverOff(532)),
							$mdgriffith$elm_ui$Element$htmlAttribute(
							A2($elm$html$Html$Attributes$style, 'filter', dropShadowValue))
						]),
					{
						description: 'Logo de Mikel',
						src: _Utils_eq(model.route, $author$project$Route$HomepageRoute) ? 'assets/favicon.svg' : 'assets/esquema.webp'
					})
				])));
};
var $author$project$Views$Header$headerHtml = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Views$Header$encabezadoFijado(model)
			]));
};
...
var $author$project$Views$Modal$modalViewFun = function (view) {
	var close = $author$project$Styles$closeButton(
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$alignRight,
				$mdgriffith$elm_ui$Element$pointer,
				$mdgriffith$elm_ui$Element$Events$onClick($author$project$Types$CloseModal),
				$mdgriffith$elm_ui$Element$Events$onMouseEnter(
				$author$project$Types$HoverOn(99)),
				$mdgriffith$elm_ui$Element$Events$onMouseLeave(
				$author$project$Types$HoverOff(99)),
				$mdgriffith$elm_ui$Element$htmlAttribute(
				A2($elm$html$Html$Attributes$style, 'filter', 'drop-shadow(3px 3px 1px darkgray)'))
			]));
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
						$mdgriffith$elm_ui$Element$inFront(close)
					]),
				_List_fromArray(
					[view]))
			]));
};
var $author$project$Types$ScheduleClose = {$: 'ScheduleClose'};
var $author$project$Views$Botones$botonHome = F2(
	function (id, hovered) {
		var _v0 = A2($elm$core$Set$member, id, hovered) ? _Utils_Tuple2(
			_List_fromArray(
				[
							...
							A2(
									...
									]),
								{
									label: A2(
										...
										$mdgriffith$elm_ui$Element$text('Esquema')),
									url: $author$project$Route$encode($author$project$Route$HomepageRoute)
								}))
						]))),
			_List_fromArray(
...
var $author$project$Views$Menu$view = function (model) {
	var sideFiller = A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
	...
	var mainBlock = A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$spacing(10),
				$mdgriffith$elm_ui$Element$paddingEach(
				{bottom: 20, left: 0, right: 10, top: 10})
			]),
		A2(
			$elm$core$List$cons,
			A2($author$project$Views$Botones$botonHome, 4001, model.hovered),
			A2(
				$elm$core$List$indexedMap,
				F2(
					function (i, _v0) {
						var k = _v0.a;
						var e = _v0.b;
						return A3($author$project$Views$Botones$botonEntregable, e, 2000 + i, model.hovered);
					}),
				$elm$core$Dict$toList($author$project$Entregables$Entregables$entregables))));
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Border$solid,
				$mdgriffith$elm_ui$Element$Border$color($author$project$Styles$negro),
				$mdgriffith$elm_ui$Element$Events$onMouseLeave($author$project$Types$ScheduleClose),
				$mdgriffith$elm_ui$Element$Events$onMouseEnter($author$project$Types$OpenMenu)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[sideFiller, mainBlock, sideFiller]))
			]));
};
var $author$project$Views$DesktopView$view = function (model) {
	var menu = function () {
		var _v2 = model.menuVisible;
		if (_v2.$ === 'Hidden') {
			return _List_Nil;
		} else {
			return _List_fromArray(
				[
					$mdgriffith$elm_ui$Element$inFront(
					$author$project$Views$Menu$view(model))
				]);
		}
	}();
	var entregable = function () {
		var _v1 = model.entregableVisibility;
		if (_v1.$ === 'Hidden') {
			return $author$project$Views$DesktopView$contenido(model);
		} else {
			return A2(
				$mdgriffith$elm_ui$Element$row,
				_List_fromArray(
	...
	var content = function () {
		var _v0 = model.modalVisibility;
		if (_v0.$ === 'Hidden') {
			return entregable;
		} else {
			return $author$project$Views$Modal$modalViewFun($author$project$Entregables$Entregable2B$diagramaEngrande);
		}
	}();
	return A2(
		$elm$html$Html$div,
		...
		_List_fromArray(
			[
				$author$project$Views$Header$headerHtml(model),
				A2(
				$mdgriffith$elm_ui$Element$layout,
				_Utils_ap(
					menu,
				...
				A2(
					...
					_List_fromArray(
						[
							...
							content),
							$author$project$Views$Footer$footer
						])))
			]));
};
var $author$project$Views$Header$header = function (button) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$spacing(10),
				$mdgriffith$elm_ui$Element$height(
				A2($mdgriffith$elm_ui$Element$maximum, 70, $mdgriffith$elm_ui$Element$fill)),
				$mdgriffith$elm_ui$Element$Background$color($author$project$Styles$blanco),
				A2($mdgriffith$elm_ui$Element$paddingXY, 20, 0),
				$mdgriffith$elm_ui$Element$Border$widthEach(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$el,
				$author$project$Styles$montserratBold,
				$mdgriffith$elm_ui$Element$text('   B1 Digitalizazioa')),
				button
			]));
};
var $author$project$Types$Desc = {$: 'Desc'};
var $author$project$Types$SortEntregables = function (a) {
	return {$: 'SortEntregables', a: a};
};
var $author$project$Views$Botones$sortOrderButton = function (model) {
	var imageAttrs = _List_fromArray(
		[
			A2($mdgriffith$elm_ui$Element$paddingXY, 0, 0),
			$mdgriffith$elm_ui$Element$height(
			$mdgriffith$elm_ui$Element$px(40)),
			$mdgriffith$elm_ui$Element$alignRight,
			$mdgriffith$elm_ui$Element$htmlAttribute(
			A2($elm$html$Html$Attributes$style, 'filter', 'drop-shadow(2px 2px 0px #000000)'))
		]);
	...
	if (_v0.$ === 'Categories') {
		return A2(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Element$Events$onClick(
					$author$project$Types$SortEntregables($author$project$Types$Desc)),
				imageAttrs),
			{description: 'Logo de Categorias', src: 'assets/sort-categories.svg'});
	} else {
		return A2(
			$mdgriffith$elm_ui$Element$image,
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Element$Events$onClick(
					$author$project$Types$SortEntregables($author$project$Types$Categories)),
				imageAttrs),
			{description: 'Logo de Ordenar', src: 'assets/sort-desc.svg'});
	}
};
var $author$project$Views$Header$phoneHeader = function (model) {
	return $author$project$Views$Header$header(
		$author$project$Views$Botones$sortOrderButton(model));
};
var $author$project$Types$GoTo = function (a) {
	return {$: 'GoTo', a: a};
};
var $author$project$Views$Botones$backButton = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$image,
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$alignRight,
				$mdgriffith$elm_ui$Element$htmlAttribute(
				A2($elm$html$Html$Attributes$style, 'filter', 'drop-shadow(2px 2px 0px #666666)')),
				$mdgriffith$elm_ui$Element$Events$onClick(
				$author$project$Types$GoTo($author$project$Route$HomepageRoute))
			]),
		{description: 'Logo de Ordenar', src: 'assets/esquema.webp'});
};
var $author$project$Views$Header$phoneHeaderBack = function (model) {
	return $author$project$Views$Header$header(
		$author$project$Views$Botones$backButton(model));
};
var $author$project$Entregables$Entregables$getSeccionByCodeDict = F2(
	function (code, dict) {
		var _v0 = A2($elm$core$Dict$get, code, dict);
		if (_v0.$ === 'Just') {
			var sec = _v0.a;
			return sec;
		} else {
...
var $author$project$Entregables$Entregables$seccionesEnOrden = function () {
	var dict = $author$project$Entregables$Entregables$secciones;
	return A2(
		$elm$core$List$map,
		function (s) {
			return A2($author$project$Entregables$Entregables$getSeccionByCodeDict, s, dict);
		},
		_List_fromArray(
			['ambitoscompe', 'concolab', 'ensapre', 'preeval', 'conbasico', 'conprofund', 'colabalumn', 'evlaretro']));
}();
var $author$project$Views$PhoneView$view = function (model) {
	var sideFiller = A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
		...
		$mdgriffith$elm_ui$Element$none);
	var phoneHeaderView = _Utils_eq(model.entregableVisibility, $author$project$Types$Visible) ? $author$project$Views$Header$phoneHeaderBack(model) : $author$project$Views$Header$phoneHeader(model);
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$spacing(10),
						$mdgriffith$elm_ui$Element$paddingEach(
						{bottom: 20, left: 0, right: 10, top: 80})
					]),
				A2(
					$elm$core$List$indexedMap,
					F2(
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$centerY,
						$mdgriffith$elm_ui$Element$width(
						$mdgriffith$elm_ui$Element$fillPortion(17)),
						$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
						$mdgriffith$elm_ui$Element$spacing(10),
						$mdgriffith$elm_ui$Element$paddingEach(
						{bottom: 20, left: 10, right: 10, top: 80})
					]),
				A2(
					$elm$core$List$indexedMap,
					F2(
							...
							return A2(
								...
								_Utils_ap(
									...
									_List_fromArray(
										[
											$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
											$mdgriffith$elm_ui$Element$Background$color(s.color),
											$mdgriffith$elm_ui$Element$spacing(10),
											$mdgriffith$elm_ui$Element$paddingEach(
										...
										[
											...
											_List_fromArray(
												[
													...
													$mdgriffith$elm_ui$Element$el,
													$author$project$Styles$montserratBold,
													$mdgriffith$elm_ui$Element$text(s.titulo))
												]))
										]),
									A2(
										$elm$core$List$indexedMap,
										F2(
											function (j, e) {
												return A3($author$project$Views$Botones$botonEntregable, e, (i * 1000) + j, model.hovered);
											}),
										s.entregables)));
						}),
					$author$project$Entregables$Entregables$seccionesEnOrden));
		}
	}();
	return A2(
		$mdgriffith$elm_ui$Element$layout,
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$centerX,
				$mdgriffith$elm_ui$Element$centerY,
				$mdgriffith$elm_ui$Element$inFront(phoneHeaderView)
			]),
		A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				...
				[
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$fill),
							$mdgriffith$elm_ui$Element$paddingEach(
							{bottom: 50, left: 0, right: 0, top: 40})
						]),
					_List_fromArray(
						[
							sideFiller,
							_Utils_eq(model.entregableVisibility, $author$project$Types$Visible) ? A2(
							$mdgriffith$elm_ui$Element$el,
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$centerX,
							...
							model.entregableView(model.dimensions)) : mainBlock,
							sideFiller
						])),
					$author$project$Views$Footer$footer
				])));
	...
	return {
		body: _List_fromArray(
			[
				...
				switch (deviceClass.$) {
					case 'Phone':
						return $author$project$Views$PhoneView$view(model);
					case 'Tablet':
						return $author$project$Views$DesktopView$view(model);
					case 'Desktop':
						return $author$project$Views$DesktopView$view(model);
					default:
						return $author$project$Views$DesktopView$view(model);
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{init: $author$project$Main$init, onUrlChange: $author$project$Types$UrlChanged, onUrlRequest: $author$project$Types$UrlClicked, subscriptions: $author$project$Main$subscriptions, update: $author$project$Main$update, view: $author$project$Main$view});
