...
var $author$project$Main$desktopView = function (model) {
	var _v0 = function () {
...
var $author$project$Main$phoneView = function (model) {
	var sideFiller = A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
	...
	return {
		body: _List_fromArray(
			[
				...
				switch (deviceClass.$) {
					case 'Phone':
						return $author$project$Main$phoneView(model);
					case 'Tablet':
						return $author$project$Main$desktopView(model);
					case 'Desktop':
						return $author$project$Main$desktopView(model);
					default:
						return $author$project$Main$desktopView(model);
