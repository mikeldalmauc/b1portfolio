...
var $author$project$Entregables$Entregable1$title = '1 Compromiso profesional';
var $author$project$Entregables$Entregable1A$title = '1.A Comunicación - Contexto colaborativo del equipo docente';
var $author$project$Entregables$Entregable1B$title = '1.B Trabajo en equipo';
var $author$project$Entregables$Entregable1C$title = '1.A Comunicación - Contexto colaborativo del equipo docente';
var $author$project$Entregables$Entregable2$title = '1.A Comunicación - Contexto colaborativo del equipo docente';
var $author$project$Entregables$Entregable2A$title = '1.A Comunicación - Contexto colaborativo del equipo docente';
var $author$project$Entregables$Entregable2B$title = '1.A Comunicación - Contexto colaborativo del equipo docente';
var $author$project$Entregables$Entregable3$title = '1.A Comunicación - Contexto colaborativo del equipo docente';
var $author$project$Entregables$Entregable3A$title = '1.A Comunicación - Contexto colaborativo del equipo docente';
var $author$project$Entregables$Entregable3B$title = '1.A Comunicación - Contexto colaborativo del equipo docente';
var $author$project$Entregables$Entregable4$title = '1.A Comunicación - Contexto colaborativo del equipo docente';
var $author$project$Entregables$Entregable4A$title = '1.A Comunicación - Contexto colaborativo del equipo docente';
var $author$project$Entregables$Entregable4B$title = '1.A Comunicación - Contexto colaborativo del equipo docente';
var $author$project$Entregables$Entregable4C$title = '1.A Comunicación - Contexto colaborativo del equipo docente';
var $author$project$Entregables$Entregable5$title = '1.A Comunicación - Contexto colaborativo del equipo docente';
var $author$project$Entregables$Entregable5A$title = '1.A Comunicación - Contexto colaborativo del equipo docente';
var $author$project$Entregables$Entregable5B$title = '1.A Comunicación - Contexto colaborativo del equipo docente';
var $author$project$Entregables$Entregable6$title = '1.A Comunicación - Contexto colaborativo del equipo docente';
var $author$project$Entregables$Entregable6A$title = '1.A Comunicación - Contexto colaborativo del equipo docente';
var $author$project$Entregables$Entregable6B$title = '1.A Comunicación - Contexto colaborativo del equipo docente';
var $author$project$Entregables$Entregable6C$title = '6C Contenidos Digitales';
var $author$project$Entregables$Entregable6D$title = '1.A Comunicación - Contexto colaborativo del equipo docente';
var $author$project$Entregables$Entregable6E$title = '1.A Comunicación - Contexto colaborativo del equipo docente';
...
var $author$project$MarkdownThemed$renderer = function (theme) {
	return {
		...
		link: F2(
			function (_v5, list) {
				var title = _v5.title;
				var destination = _v5.destination;
				return A2(
...
var $author$project$Views$ContenidosViews$breadcrumbs = F2(
	function (d, entregables) {
		...
		var routes = A2(
			$elm$core$List$cons,
			A2(link, $author$project$Route$HomepageRoute, 'Inicio'),
			A2(
				$elm$core$List$map,
				function (entregable) {
					if (entregable.$ === 'Just') {
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$core$Maybe$Just(
						_Utils_Tuple2($author$project$Route$Entregable1, $author$project$Entregables$Entregable1$title)),
						$elm$core$Maybe$Just(
						_Utils_Tuple2($author$project$Route$Entregable1A, $author$project$Entregables$Entregable1A$title))
					])),
...
var $author$project$Views$ContenidosViews$videoView = function (src) {
	return $mdgriffith$elm_ui$Element$html(
		A2(
			$elm$html$Html$div,
			_List_Nil,
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text($author$project$Entregables$Entregable1B$testText)
					])),
				A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
				...
				$author$project$Views$ContenidosViews$videoView('https://www.youtube.com/embed/o5Gv4_FdcYs?si=pcHtFUzWvv0IjbrM')),
				A2(
				$mdgriffith$elm_ui$Element$paragraph,
				_List_Nil,
				_List_fromArray(
	...
	_List_fromArray(
		[
			...
			A6(
				...
				$author$project$Entregables$Entregable1$title,
			...
			A6(
				...
				$elm$core$Maybe$Just('video'),
				$author$project$Entregables$Entregable2$title,
			...
			A6(
				...
				$elm$core$Maybe$Just('video'),
				$author$project$Entregables$Entregable3$title,
			...
			A6(
				...
				$elm$core$Maybe$Just('video'),
				$author$project$Entregables$Entregable4$title,
			...
			A6(
				...
				$elm$core$Maybe$Just('video'),
				$author$project$Entregables$Entregable5$title,
			...
			A6(
				...
				$elm$core$Maybe$Just('video'),
				$author$project$Entregables$Entregable6$title,
			...
			A6(
				...
				$author$project$Entregables$Entregable1A$title,
			...
			A6(
				...
				'Trabajo en equipo',
				$elm$core$Maybe$Just('captura'),
				$author$project$Entregables$Entregable1B$title,
			...
			A6(
				...
				$author$project$Entregables$Entregable1C$title,
			...
			A6(
				...
				$author$project$Entregables$Entregable2A$title,
			...
			A6(
				...
				'Profundización',
				$elm$core$Maybe$Just('contenido'),
				$author$project$Entregables$Entregable2B$title,
				$author$project$Entregables$Entregable2B$view)),
			_Utils_Tuple2(
			'3.A',
			A6($author$project$Types$Entregable, '3.A', $author$project$Route$Entregable3A, 'Contexto colaborativo del alumnado', $elm$core$Maybe$Nothing, $author$project$Entregables$Entregable3A$title, $author$project$Entregables$Entregable3A$view)),
			_Utils_Tuple2(
			'3.B',
			A6($author$project$Types$Entregable, '3.B', $author$project$Route$Entregable3B, 'Recursos', $elm$core$Maybe$Nothing, $author$project$Entregables$Entregable3B$title, $author$project$Entregables$Entregable3B$view)),
			_Utils_Tuple2(
			'4.A',
			A6($author$project$Types$Entregable, '4.A', $author$project$Route$Entregable4A, 'Evaluación previa', $elm$core$Maybe$Nothing, $author$project$Entregables$Entregable4A$title, $author$project$Entregables$Entregable4A$view)),
			_Utils_Tuple2(
			'4.B',
			A6($author$project$Types$Entregable, '4.B', $author$project$Route$Entregable4B, 'Formativa', $elm$core$Maybe$Nothing, $author$project$Entregables$Entregable4B$title, $author$project$Entregables$Entregable4B$view)),
			_Utils_Tuple2(
			'4.C',
			A6($author$project$Types$Entregable, '4.C', $author$project$Route$Entregable4C, 'Retroalimentación', $elm$core$Maybe$Nothing, $author$project$Entregables$Entregable4C$title, $author$project$Entregables$Entregable4C$view)),
			_Utils_Tuple2(
			'5.A',
			A6($author$project$Types$Entregable, '5.A', $author$project$Route$Entregable5A, 'Accesibilidad', $elm$core$Maybe$Nothing, $author$project$Entregables$Entregable5A$title, $author$project$Entregables$Entregable5A$view)),
			_Utils_Tuple2(
			'5.B',
			A6($author$project$Types$Entregable, '5.B', $author$project$Route$Entregable5B, 'Personalización', $elm$core$Maybe$Nothing, $author$project$Entregables$Entregable5B$title, $author$project$Entregables$Entregable5B$view)),
			_Utils_Tuple2(
			'6.A',
			A6(
				$author$project$Types$Entregable,
				...
				$author$project$Entregables$Entregable6A$title,
			...
			A6(
				...
				'Normas de conducta',
				$elm$core$Maybe$Just('doc'),
				$author$project$Entregables$Entregable6B$title,
			...
			A6(
				...
				'Contenidos digitales',
				$elm$core$Maybe$Just('doc'),
				$author$project$Entregables$Entregable6C$title,
			...
			A6(
				...
				'Uso responsable',
				$elm$core$Maybe$Just('doc'),
				$author$project$Entregables$Entregable6D$title,
			...
			A6(
				...
				$elm$core$Maybe$Just('doc'),
				$author$project$Entregables$Entregable6E$title,
					...
					if (_v5.$ === 'Just') {
						...
						return A2(
							...
							A2(
								$elm$core$Task$andThen,
								function (elem) {
									return A2($elm$browser$Browser$Dom$setViewport, 0, elem.element.y);
								},
