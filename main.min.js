...
var $author$project$Entregables$Entregable1B$videoView = function (src) {
	return $mdgriffith$elm_ui$Element$html(
		A2(
			$elm$html$Html$div,
			_List_Nil,
...
var $author$project$Entregables$Entregable1B$view = A2(
	...
	$author$project$Entregables$Entregable1B$videoView('https://www.youtube.com/embed/o5Gv4_FdcYs?si=pcHtFUzWvv0IjbrM'));
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'UrlChanged':
				var url = msg.a;
				var _v4 = $author$project$Types$getEntregableFromRoute(
					$author$project$Route$decode(url));
				if (_v4.$ === 'Just') {
					var entregable = _v4.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
...
var $author$project$Main$infoDebug = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$text(
				'key: ' + $elm$core$Debug$toString(model.key)),
				$mdgriffith$elm_ui$Element$text(
				...
				$mdgriffith$elm_ui$Element$text(
				'hovered: ' + $elm$core$Debug$toString(model.hovered)),
				$mdgriffith$elm_ui$Element$text(
				'modalVisibility: ' + $elm$core$Debug$toString(model.modalVisibility)),
				$mdgriffith$elm_ui$Element$text('modalTitle: ' + model.modalTitle),
				$mdgriffith$elm_ui$Element$text(
				'entregables: ' + $elm$core$Debug$toString(model.entregables)),
				$mdgriffith$elm_ui$Element$text(
				'sortOrder: ' + $elm$core$Debug$toString(model.sortOrder))
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$html$Html$Events$onClick($author$project$Types$CloseModal)
			]),
		_List_fromArray(
			[
				A2(
...
var $author$project$Views$Header$sortOrderButton = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Views$Header$sortOrderButton(model)
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$centerY,
				$mdgriffith$elm_ui$Element$inFront(
				$author$project$Views$Header$phoneHeader(model))
			]),
		A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[sideFiller, centerCol, sideFiller])),
					$author$project$Views$Footer$footer
				])));
};
