...
var $author$project$Entregables$Entregable1$title = '1.A Comunicación - Contexto colaborativo del equipo docente';
...
var $author$project$MarkdownThemed$lightTheme = {
	...
	link: A3($mdgriffith$elm_ui$Element$rgb255, 12, 82, 200),
...
var $author$project$MarkdownThemed$heading1 = $author$project$Styles$montserratBold;
		...
		return A2(
			...
			_Utils_ap(
				function () {
					...
					switch (_v1) {
						case 1:
							return $author$project$MarkdownThemed$heading1;
						case 2:
							return _List_fromArray(
								[
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$px((16 * numberOfLines) + 24)),
						$mdgriffith$elm_ui$Element$htmlAttribute(
...
var $author$project$Views$Contenidos$videoView = function (src) {
	return $mdgriffith$elm_ui$Element$html(
		A2(
			$elm$html$Html$div,
			_List_Nil,
...
var $author$project$Entregables$Entregable1B$view = A2(
	$mdgriffith$elm_ui$Element$el,
	_List_fromArray(
		[$mdgriffith$elm_ui$Element$scrollbars, $mdgriffith$elm_ui$Element$centerX, $mdgriffith$elm_ui$Element$centerY]),
	$author$project$Views$Contenidos$videoView('https://www.youtube.com/embed/o5Gv4_FdcYs?si=pcHtFUzWvv0IjbrM'));
...
var $author$project$Entregables$Entregable6E$view = A2(
	...
	_List_fromArray(
		[$mdgriffith$elm_ui$Element$scrollbars]),
	$author$project$MarkdownThemed$renderFull('\r\n# B1 portfolio website\r\n\r\nEsta es una web estilo SPA (Single Page Application) desarrollada en ELM. Visita la web en [mikeldalmau.uk](https://mikeldalmau.uk)\r\n\r\n- [B1 portfolio website](#b1-portfolio-website)\r\n  - [Ejecutar el entorno de desarrollo](#ejecutar-el-entorno-de-desarrollo)\r\n    - [Troubleshooting :wrench:](#troubleshooting-wrench)\r\n  - [Preparar la web para producción :rocket:](#preparar-la-web-para-producción-rocket)\r\n    - [Troubleshooting :wrench:](#troubleshooting-wrench-1)\r\n  - [Extensiones Recomendadas :rainbow:](#extensiones-recomendadas-rainbow)\r\n\r\n\r\n## Ejecutar el entorno de desarrollo \r\n\r\nEl entorno de desarrollo utiliza un único contenedor Debian con node y elm. Para ejecutarlo es necesario tener instalado Docker y Docker Compose.\r\n\r\n```bash\r\ndocker compose up --build\r\n```\r\n\r\nUn vez que la imagen del contenedor esté construida y el contenedor esté en ejecución, se puede acceder a la web en la dirección http://localhost:8000. Ya no hace flata que agregues el el parametro --build, a menos que quieras reconstruir la imagen.\r\n\r\n```bash\r\ndocker compose up\r\n```\r\n\r\nEs apropiado en este caso no usar el parametro `-d` ya que se necesita ver la salida de la consola para ver los mensajes de error del live server y de la compilación de elm. \r\n\r\n\r\n### Troubleshooting :wrench:\r\n\r\nSi tienes problemas con la descarga de paquetes de debian al construir el contenedor, en windows puedes intentar con el siguiente comando: `ipconfig /flushdns` para borrar el cache de la resolución de nombres DNS.\r\n\r\n## Preparar la web para producción :rocket:\r\n\r\nAverigua el nombre del contendor y accede al este con el siguiente comando:\r\n\r\n```bash\r\ndocker exec -it nombre-contendor bash\r\n```\r\n\r\nLanza el comando `gulp` para generar la web en la carpeta `build`.\r\n\r\n```bash\r\ngulp\r\n```\r\n\r\nEl contenido de la carpeta `build` se puede servir directamnete con cualquier servidor web ya que esta todo construido y minificado.\r\n\r\n\r\n### Troubleshooting :wrench: \r\n\r\nSi no compila elm es posible que haya sentencias Debug.log en el código. Elm no permite sentencias de log en producción.\r\n\r\n## Extensiones Recomendadas :rainbow:\r\n\r\n![alt text](doc/image.png)\r\n\r\n--- \r\n\r\n\r\n```\r\n'));
var $author$project$Types$entregables = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2(
			'1',
...
var $author$project$Types$getEntregableFromRoute = function (route) {
	return $elm$core$List$head(
		$elm$core$Dict$values(
			A2(
				...
				$author$project$Types$entregables)));
};
...
var $author$project$Main$init = F3(
	function (dimensions, url, key) {
		...
		var baseModel = {
			...
			entregables: $author$project$Types$entregables,
		...
		var _v0 = $author$project$Types$getEntregableFromRoute(route);
		if (_v0.$ === 'Just') {
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'UrlChanged':
				var url = msg.a;
				var _v2 = $author$project$Types$getEntregableFromRoute(
					$author$project$Route$decode(url));
				if (_v2.$ === 'Just') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								route: $author$project$Route$decode(url)
							}),
...
var $author$project$Types$colorFromCode = function (code) {
...
var $author$project$Views$Botones$botonCompetencia = F4(
	function (entregable, entrega, ids, hovered) {
		var color = $author$project$Types$colorFromCode(entregable.codigo);
		var _v0 = function () {
...
var $author$project$Types$getEntregable = F2(
	function (key, dict) {
		var _v0 = A2($elm$core$Dict$get, key, dict);
		if (_v0.$ === 'Just') {
			var entregable = _v0.a;
...
var $author$project$Types$secciones = function () {
	var dictEntregables = $author$project$Types$entregables;
			...
			[
				...
				'ambitoscompe',
				{
					...
					entregables: A2(
						$elm$core$List$map,
						function (e) {
							return A2($author$project$Types$getEntregable, e, dictEntregables);
						},
						_List_fromArray(
							['1', '2', '3', '4', '5', '6'])),
...
var $author$project$Types$getSeccionByCode = function (code) {
	var secc = $author$project$Types$secciones;
...
var $author$project$Views$DesktopMain$aside = function (model) {
	var seccion = $author$project$Types$getSeccionByCode('ambitoscompe');
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						A2($author$project$Types$getEntregable, '1', model.entregables),
						'1a entrega',
						_List_fromArray(
							[100, 1, 2, 3]),
						model.hovered),
						A4(
						$author$project$Views$Botones$botonCompetencia,
						A2($author$project$Types$getEntregable, '2', model.entregables),
						'2a entrega',
						_List_fromArray(
							[101, 8, 10]),
						model.hovered),
						A4(
						$author$project$Views$Botones$botonCompetencia,
						A2($author$project$Types$getEntregable, '3', model.entregables),
						'4a entrega',
						_List_fromArray(
							[102, 4, 5]),
						model.hovered),
						A4(
						$author$project$Views$Botones$botonCompetencia,
						A2($author$project$Types$getEntregable, '4', model.entregables),
						'6a entrega',
						_List_fromArray(
							[103, 6, 18, 19]),
						model.hovered),
						A4(
						$author$project$Views$Botones$botonCompetencia,
						A2($author$project$Types$getEntregable, '5', model.entregables),
						'3a entrega',
						_List_fromArray(
							[104, 9, 11, 12]),
						model.hovered),
						A4(
						$author$project$Views$Botones$botonCompetencia,
						A2($author$project$Types$getEntregable, '6', model.entregables),
						'5a entrega',
						_List_fromArray(
							[105, 13, 14, 15, 16, 17]),
						model.hovered)
				...
				_Utils_ap(
					...
					_List_fromArray(
						[
							...
							$author$project$Types$colorFromCode(entregable.codigo)),
							$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
							$mdgriffith$elm_ui$Element$height(
							$mdgriffith$elm_ui$Element$px(60)),
							$mdgriffith$elm_ui$Element$padding(10),
...
var $author$project$Views$DesktopMain$contenidoProfundizacion = function (model) {
	var seccion = $author$project$Types$getSeccionByCode('conprofund');
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_Utils_ap(
			$author$project$Styles$borderStyle,
			...
			[
				...
				_List_fromArray(
					[
						...
						A2($author$project$Types$getEntregable, '2.B', model.entregables),
						10,
						model.hovered),
						A3(
						$author$project$Views$Botones$botonEntregable,
						A2($author$project$Types$getEntregable, '5.A', model.entregables),
						11,
						model.hovered),
						A3(
						$author$project$Views$Botones$botonEntregable,
						A2($author$project$Types$getEntregable, '5.B', model.entregables),
						12,
						model.hovered)
					]))
			]));
...
var $author$project$Views$DesktopMain$contenidoBasico = function (model) {
	var seccion = $author$project$Types$getSeccionByCode('conbasico');
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						A3(
						$author$project$Views$Botones$botonEntregable,
						A2($author$project$Types$getEntregable, '2.A', model.entregables),
						8,
						model.hovered),
						A3(
						$author$project$Views$Botones$botonEntregable,
...
var $author$project$Views$DesktopMain$contextoColaborativoAlumnado = function (model) {
	var seccion = $author$project$Types$getSeccionByCode('colabalumn');
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_Utils_ap(
			$author$project$Styles$borderStyle,
			...
			[
				...
				_List_fromArray(
					[
						A3(
						$author$project$Views$Botones$botonEntregable,
						A2($author$project$Types$getEntregable, '6.A', model.entregables),
						13,
						model.hovered),
						A3(
						$author$project$Views$Botones$botonEntregable,
						A2($author$project$Types$getEntregable, '6.B', model.entregables),
						14,
						model.hovered),
						A3(
						$author$project$Views$Botones$botonEntregable,
						A2($author$project$Types$getEntregable, '6.C', model.entregables),
						15,
						model.hovered)
					])),
				A2(
				...
				_List_fromArray(
					[
						A3(
						$author$project$Views$Botones$botonEntregable,
						A2($author$project$Types$getEntregable, '6.D', model.entregables),
						16,
						model.hovered),
						A3(
						$author$project$Views$Botones$botonEntregable,
						A2($author$project$Types$getEntregable, '6.E', model.entregables),
						17,
						model.hovered)
					]))
			]));
...
var $author$project$Views$DesktopMain$evaluacionPrevia = function (model) {
	var seccion = $author$project$Types$getSeccionByCode('preeval');
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_Utils_ap(
			$author$project$Styles$borderStyle,
		...
		_List_fromArray(
			[
				...
				A3(
				$author$project$Views$Botones$botonEntregable,
				A2($author$project$Types$getEntregable, '4.A', model.entregables),
				6,
				model.hovered)
			]));
};
var $author$project$Views$DesktopMain$evaluacionYRetroalimentacion = function (model) {
	var seccion = $author$project$Types$getSeccionByCode('evlaretro');
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_Utils_ap(
			$author$project$Styles$borderStyle,
			...
			[
				...
				_List_fromArray(
					[
						A3(
						$author$project$Views$Botones$botonEntregable,
						A2($author$project$Types$getEntregable, '4.B', model.entregables),
						18,
						model.hovered),
						A3(
						$author$project$Views$Botones$botonEntregable,
						A2($author$project$Types$getEntregable, '4.C', model.entregables),
						19,
						model.hovered)
					]))
			]));
...
var $author$project$Views$DesktopMain$contextoColaborativo = function (model) {
	var seccion = $author$project$Types$getSeccionByCode('concolab');
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						A3(
						$author$project$Views$Botones$botonEntregable,
						A2($author$project$Types$getEntregable, '1.A', model.entregables),
						1,
						model.hovered),
						A3(
						$author$project$Views$Botones$botonEntregable,
						A2($author$project$Types$getEntregable, '1.B', model.entregables),
						2,
						model.hovered),
						A3(
						$author$project$Views$Botones$botonEntregable,
						A2($author$project$Types$getEntregable, '1.C', model.entregables),
						3,
						model.hovered)
					]))
			]));
...
var $author$project$Views$DesktopMain$ensenanzaAprendizaje = function (model) {
	var seccion = $author$project$Types$getSeccionByCode('ensapre');
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						A3(
						$author$project$Views$Botones$botonEntregable,
						A2($author$project$Types$getEntregable, '3.A', model.entregables),
						4,
						model.hovered),
						A3(
						$author$project$Views$Botones$botonEntregable,
						A2($author$project$Types$getEntregable, '3.B', model.entregables),
						5,
						model.hovered)
					]))
			]));
...
var $author$project$Views$Modal$modalViewFun = function (model) {
...
var $author$project$Views$Modal$viewOverlay = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$layout,
						_List_Nil,
						$author$project$Views$Modal$modalViewFun(model))
					]))
			]));
};
var $author$project$Views$DesktopMain$view = function (model) {
	var _v0 = function () {
		var _v1 = model.modalVisibility;
		if (_v1.$ === 'Hidden') {
			return _Utils_Tuple2(
				_List_fromArray(
					[
			...
			return _Utils_Tuple2(
				...
				_List_fromArray(
					[
						$author$project$Views$Modal$viewOverlay(model)
					]));
		}
	}();
	var modalAttrs = _v0.a;
	var modal = _v0.b;
	return A2(
		$elm$html$Html$div,
		_Utils_ap(
						...
						A2(
							...
							_List_fromArray(
								[
									...
									$author$project$Views$DesktopMain$contenido(model)),
...
var $author$project$Types$getSeccionByCodeDict = F2(
	function (code, dict) {
...
var $author$project$Types$seccionesEnOrden = function () {
	var dict = $author$project$Types$secciones;
	return A2(
		$elm$core$List$map,
		function (s) {
			return A2($author$project$Types$getSeccionByCodeDict, s, dict);
		},
		_List_fromArray(
		...
		if (_v0.$ === 'Desc') {
			return A2(
				...
				A2(
					...
					$elm$core$Dict$toList($author$project$Types$entregables)));
		} else {
			return A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
				...
				A2(
					...
					$author$project$Types$seccionesEnOrden));
		}
	}();
	return A2(
		$mdgriffith$elm_ui$Element$layout,
