...
var $author$project$Types$LottieMsg = function (a) {
	return {$: 'LottieMsg', a: a};
};
var $author$project$Lottie$Play = {$: 'Play'};
...
var $author$project$Lottie$init = function (givenId) {
	return _Utils_Tuple2(
		{containerId: givenId},
...
var $author$project$Main$init = F3(
	function (dimensions, url, key) {
		...
		var _v0 = $author$project$Lottie$init('teaching-animation');
		var lottieModel = _v0.a;
		var lottieCmd = _v0.b;
		var baseModel = {
		...
		var _v1 = $author$project$Entregables$Entregables$getEntregableFromRoute(route);
		if (_v1.$ === 'Just') {
			var entregable = _v1.a;
			return _Utils_Tuple2(
				_Utils_update(
					baseModel,
				...
				A2(
					$elm$core$Task$perform,
					function (_v2) {
						return $author$project$Types$LottieMsg($author$project$Lottie$Play);
					},
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'animationId',
					$elm$json$Json$Encode$string($.animationId)),
					_Utils_Tuple2(
					'jsonPath',
					$elm$json$Json$Encode$string($.jsonPath))
				]));
	});
...
var $author$project$Lottie$update = F2(
	function (msg, model) {
		if (msg.$ === 'NoOp') {
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				var subMsg = msg.a;
				var _v7 = A2($author$project$Lottie$update, subMsg, model.lottie);
				var newLottieModel = _v7.a;
				var subCmd = _v7.b;
				if (subMsg.$ === 'Play') {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{lottie: newLottieModel}),
						$elm$core$Platform$Cmd$batch(
							_List_fromArray(
								[
									A2($elm$core$Platform$Cmd$map, $author$project$Types$LottieMsg, subCmd),
									$author$project$Main$playLottie(
									{animationId: newLottieModel.containerId, jsonPath: 'assets/' + (newLottieModel.containerId + '.json')})
								])));
				} else {
					return _Utils_Tuple2(
						_Utils_update(
...
var $author$project$Lottie$view = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$htmlAttribute(
				$elm$html$Html$Attributes$id(model.containerId)),
				$mdgriffith$elm_ui$Element$htmlAttribute(
				$elm$html$Html$Attributes$id(model.containerId)),
				$mdgriffith$elm_ui$Element$width(
				...
				$mdgriffith$elm_ui$Element$moveRight(700),
				$mdgriffith$elm_ui$Element$htmlAttribute(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
				$mdgriffith$elm_ui$Element$inFront(
				$author$project$Lottie$view(model.lottie))
			]),
		_List_fromArray(
			[
