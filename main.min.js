...
var $author$project$Route$decode = function (url) {
	return function (a) {
		return A2(
			...
			A2($elm$url$Url$Parser$parse, a, url));
	}(
...
var $author$project$Types$Entregable = F5(
...
var $author$project$Types$entregables = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			...
			_Utils_Tuple2(
			'3.A',
			A5($author$project$Types$Entregable, '3.A', 'Contexto colaborativo del alumnado', $elm$core$Maybe$Nothing, $author$project$Entregables$Entregable1AComunicacion$title, $author$project$Entregables$Entregable1AComunicacion$view)),
			_Utils_Tuple2(
			'3.B',
			A5($author$project$Types$Entregable, '3.B', 'Recursos', $elm$core$Maybe$Nothing, $author$project$Entregables$Entregable1AComunicacion$title, $author$project$Entregables$Entregable1AComunicacion$view)),
			_Utils_Tuple2(
			'4.A',
			A5($author$project$Types$Entregable, '4.A', 'Evaluación previa', $elm$core$Maybe$Nothing, $author$project$Entregables$Entregable1AComunicacion$title, $author$project$Entregables$Entregable1AComunicacion$view)),
			_Utils_Tuple2(
			'4.B',
			A5($author$project$Types$Entregable, '4.B', 'Formativa', $elm$core$Maybe$Nothing, $author$project$Entregables$Entregable1AComunicacion$title, $author$project$Entregables$Entregable1AComunicacion$view)),
			_Utils_Tuple2(
			'4.C',
			A5($author$project$Types$Entregable, '4.C', 'Retroalimentación', $elm$core$Maybe$Nothing, $author$project$Entregables$Entregable1AComunicacion$title, $author$project$Entregables$Entregable1AComunicacion$view)),
			_Utils_Tuple2(
			'5.A',
			A5($author$project$Types$Entregable, '5.A', 'Accesibilidad', $elm$core$Maybe$Nothing, $author$project$Entregables$Entregable1AComunicacion$title, $author$project$Entregables$Entregable1AComunicacion$view)),
			_Utils_Tuple2(
			'5.B',
			A5($author$project$Types$Entregable, '5.B', 'Personalización', $elm$core$Maybe$Nothing, $author$project$Entregables$Entregable1AComunicacion$title, $author$project$Entregables$Entregable1AComunicacion$view)),
			_Utils_Tuple2(
			'6.A',
			A5(
				$author$project$Types$Entregable,
		...
		switch (msg.$) {
			...
			case 'OpenModal':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{modalTitle: modalTitle, modalView: modalView, modalVisibility: $author$project$Types$Visible}),
					$elm$core$Platform$Cmd$none);
			case 'CloseModal':
				return _Utils_Tuple2(
					_Utils_update(
...
var $author$project$Types$OpenModal = F2(
	function (a, b) {
...
var $author$project$Componentes$Botones$botonCompetencia = F4(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2($author$project$Types$OpenModal, entregable.tituloModal, entregable.vistaModal))
				]),
			_List_fromArray(
				[
					A2(
...
var $author$project$Types$getEntregable = F2(
	function (key, dict) {
		...
		if (_v0.$ === 'Just') {
			...
			return A5($author$project$Types$Entregable, '0', 'Esto no es un entregable', $elm$core$Maybe$Nothing, 'Esta pagina no debería verse', $mdgriffith$elm_ui$Element$none);
		}
	});
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A4(
						$author$project$Componentes$Botones$botonCompetencia,
...
var $author$project$Componentes$Botones$botonEntregable = F3(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A3(
						$author$project$Componentes$Botones$botonEntregable,
...
var $author$project$Componentes$Footer$footer = A2(
	$mdgriffith$elm_ui$Element$column,
	_List_fromArray(
		[
...
var $author$project$Componentes$Header$encabezadoFijado = A2(
...
var $author$project$Componentes$Header$headerHtml = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[$author$project$Componentes$Header$encabezadoFijado]));
...
var $author$project$Componentes$Modal$modalViewFun = function (model) {
...
var $author$project$Componentes$Modal$viewOverlay = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$layout,
						_List_Nil,
						$author$project$Componentes$Modal$modalViewFun(model))
					]))
			]));
};
var $author$project$Main$desktopView = function (model) {
	var modal = function () {
		...
		if (_v0.$ === 'Hidden') {
			...
			return _List_fromArray(
				[
					$author$project$Componentes$Modal$viewOverlay(model)
				]);
		}
	}();
	return A2(
		...
		_Utils_ap(
			_List_fromArray(
				[$author$project$Componentes$Header$headerHtml]),
			_Utils_ap(
				modal,
				_List_fromArray(
					[
						...
						A2(
							...
							_List_fromArray(
								[
									...
									$author$project$Componentes$Footer$footer
								])))
					]))));
};
...
var $author$project$Componentes$Header$sortOrderButton = function (model) {
...
var $author$project$Componentes$Header$phoneHeader = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$author$project$Componentes$Header$sortOrderButton(model)
			]));
};
				...
				A2(
					...
					F2(
						function (i, _v1) {
							var k = _v1.a;
							var e = _v1.b;
							return A3($author$project$Componentes$Botones$botonEntregable, e, 2000 + i, model.hovered);
						}),
							...
							return A2(
								...
								A2(
									...
									A2(
										...
										F2(
											function (j, e) {
												return A3($author$project$Componentes$Botones$botonEntregable, e, (i * 1000) + j, model.hovered);
											}),
										s.entregables)));
						}),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Componentes$Header$phoneHeader(model))
			]),
		A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
