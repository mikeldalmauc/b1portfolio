...
var $author$project$Main$Categories = {$: 'Categories'};
	...
	return _Utils_Tuple2(
		{
			...
			sortOrder: $author$project$Main$Categories
		},
...
var $author$project$Main$HoverOffAll = {$: 'HoverOffAll'};
			...
			case 'CloseModal':
				return _Utils_Tuple2(
					...
					A2(
						$elm$core$Task$perform,
						$elm$core$Basics$identity,
						$elm$core$Task$succeed($author$project$Main$HoverOffAll)));
...
var $author$project$Main$colorFromCode = function (code) {
...
var $author$project$Main$botonCompetencia = F4(
	function (entregable, entrega, ids, hovered) {
		var color = $author$project$Main$colorFromCode(entregable.codigo);
		var _v0 = function () {
...
var $author$project$Main$secciones = function () {
	var dictEntregables = $author$project$Main$entregables;
			...
			[
				...
				'ambitoscompe',
				{
					...
					entregables: A2(
						$elm$core$List$map,
						function (e) {
							return A2($author$project$Main$getEntregable, e, dictEntregables);
						},
						_List_fromArray(
							['1', '2', '3', '4', '5', '6'])),
...
var $author$project$Main$getSeccionByCode = function (code) {
	var secc = $author$project$Main$secciones;
...
var $author$project$Main$aside = function (model) {
	var seccion = $author$project$Main$getSeccionByCode('ambitoscompe');
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				...
				_Utils_ap(
					...
					_List_fromArray(
						[
							...
							$author$project$Main$colorFromCode(entregable.codigo)),
							$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill),
							$mdgriffith$elm_ui$Element$height(
							$mdgriffith$elm_ui$Element$px(60)),
...
var $author$project$Main$contenidoProfundizacion = function (model) {
	var seccion = $author$project$Main$getSeccionByCode('conprofund');
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_Utils_ap(
			$author$project$Styles$borderStyle,
...
var $author$project$Main$contenidoBasico = function (model) {
	var seccion = $author$project$Main$getSeccionByCode('conbasico');
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
...
var $author$project$Main$contextoColaborativoAlumnado = function (model) {
	var seccion = $author$project$Main$getSeccionByCode('colabalumn');
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_Utils_ap(
			$author$project$Styles$borderStyle,
...
var $author$project$Main$evaluacionPrevia = function (model) {
	var seccion = $author$project$Main$getSeccionByCode('preeval');
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_Utils_ap(
			$author$project$Styles$borderStyle,
...
var $author$project$Main$evaluacionYRetroalimentacion = function (model) {
	var seccion = $author$project$Main$getSeccionByCode('evlaretro');
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_Utils_ap(
			$author$project$Styles$borderStyle,
...
var $author$project$Main$contextoColaborativo = function (model) {
	var seccion = $author$project$Main$getSeccionByCode('concolab');
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
...
var $author$project$Main$ensenanzaAprendizaje = function (model) {
	var seccion = $author$project$Main$getSeccionByCode('ensapre');
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
...
var $author$project$Main$SortEntregables = function (a) {
	return {$: 'SortEntregables', a: a};
};
var $author$project$Main$sortOrderButton = function (model) {
	...
	if (_v0.$ === 'Categories') {
		return A2(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Element$Events$onClick(
					$author$project$Main$SortEntregables($author$project$Main$Desc)),
				imageAttrs),
		...
		return A2(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Element$Events$onClick(
					$author$project$Main$SortEntregables($author$project$Main$Categories)),
				imageAttrs),
			{description: 'Logo de Ordenar', src: 'assets/sort-desc.svg'});
	}
};
var $author$project$Main$phoneHeader = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				$author$project$Main$sortOrderButton(model)
			]));
};
				...
				A2(
					...
					F2(
						function (i, _v1) {
							var k = _v1.a;
							var e = _v1.b;
							return A3($author$project$Main$botonEntregable, e, 2000 + i, model.hovered);
						}),
					$elm$core$Dict$toList($author$project$Main$entregables)));
		} else {
			return A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
							...
							return A2(
								...
								A2(
									...
									A2(
										...
										F2(
											function (j, e) {
												return A3($author$project$Main$botonEntregable, e, (i * 1000) + j, model.hovered);
											}),
										s.entregables)));
						}),
					$elm$core$Dict$toList($author$project$Main$secciones)));
		}
	}();
	return A2(
		$mdgriffith$elm_ui$Element$layout,
		_List_fromArray(
			[
				...
				$author$project$Main$phoneHeader(model))
			]),
		A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
