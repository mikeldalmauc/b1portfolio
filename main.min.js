	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($author$project$Views$ContenidosViews$videoView, d, 'https://www.youtube.com/embed/bLqDzeTvMA4?si=a28mboA_B6l5vBeG')
			]));
};
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'UrlChanged':
				...
				var _v3 = $author$project$Entregables$Entregables$getEntregableFromRoute(newRoute);
				if (_v3.$ === 'Just') {
					var entregable = _v3.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{route: newRoute}),
